 ...
 */var E0;function r1(){if(E0)return yi;E0=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function u(c,s,d){var v=null;if(d!==void 0&&(v=""+d),s.key!==void 0&&(v=""+s.key),"key"in s){d={};for(var y in s)y!=="key"&&(d[y]=s[y])}else d=s;return s=d.ref,{$$typeof:a,type:c,key:v,ref:s!==void 0?s:null,props:d}}return yi.Fragment=r,yi.jsx=u,yi.jsxs=u,yi}var $0;function i1(){return $0||($0=1,Us.exports=r1()),Us.exports}var $=i1(),ks={exports:{}},be={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var w0;function o1(){return w0||(w0=1,function(a){function r(U,W){var ee=U.length;U.push(W);e:for(;0<ee;){var K=ee-1>>>1,E=U[K];if(0<s(E,W))U[K]=W,U[ee]=E,ee=K;else break e}}function u(U){return U.length===0?null:U[0]}function c(U){if(U.length===0)return null;var W=U[0],ee=U.pop();if(ee!==W){U[0]=ee;e:for(var K=0,E=U.length,j=E>>>1;K<j;){var Z=2*(K+1)-1,X=U[Z],I=Z+1,fe=U[I];if(0>s(X,ee))I<E&&0>s(fe,X)?(U[K]=fe,U[I]=ee,K=I):(U[K]=X,U[Z]=ee,K=Z);else if(I<E&&0>s(fe,ee))U[K]=fe,U[I]=ee,K=I;else break e}}return W}function s(U,W){var ee=U.sortIndex-W.sortIndex;return ee!==0?ee:U.id-W.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var v=Date,y=v.now();a.unstable_now=function(){return v.now()-y}}var h=[],p=[],b=1,x=null,S=3,w=!1,_=!1,B=!1,O=!1,A=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,L=typeof setImmediate<"u"?setImmediate:null;function J(U){for(var W=u(p);W!==null;){if(W.callback===null)c(p);else if(W.startTime<=U)c(p),W.sortIndex=W.expirationTime,r(h,W);else break;W=u(p)}}function Q(U){if(B=!1,J(U),!_)if(u(h)!==null)_=!0,te||(te=!0,Ue());else{var W=u(p);W!==null&&ze(Q,W.startTime-U)}}var te=!1,ae=-1,de=5,ne=-1;function he(){return O?!0:!(a.unstable_now()-ne<de)}function Be(){if(O=!1,te){var U=a.unstable_now();ne=U;var W=!0;try{e:{_=!1,B&&(B=!1,z(ae),ae=-1),w=!0;var ee=S;try{t:{for(J(U),x=u(h);x!==null&&!(x.expirationTime>U&&he());){var K=x.callback;if(typeof K=="function"){x.callback=null,S=x.priorityLevel;var E=K(x.expirationTime<=U);if(U=a.unstable_now(),typeof E=="function"){x.callback=E,J(U),W=!0;break t}x===u(h)&&c(h),J(U)}else c(h);x=u(h)}if(x!==null)W=!0;else{var j=u(p);j!==null&&ze(Q,j.startTime-U),W=!1}}break e}finally{x=null,S=ee,w=!1}W=void 0}}finally{W?Ue():te=!1}}}var Ue;if(typeof L=="function")Ue=function(){L(Be)};else if(typeof MessageChannel<"u"){var Me=new MessageChannel,pt=Me.port2;Me.port1.onmessage=Be,Ue=function(){pt.postMessage(null)}}else Ue=function(){A(Be,0)};function ze(U,W){ae=A(function(){U(a.unstable_now())},W)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(U){U.callback=null},a.unstable_forceFrameRate=function(U){0>U||125<U?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):de=0<U?Math.floor(1e3/U):5},a.unstable_getCurrentPriorityLevel=function(){return S},a.unstable_next=function(U){switch(S){case 1:case 2:case 3:var W=3;break;default:W=S}var ee=S;S=W;try{return U()}finally{S=ee}},a.unstable_requestPaint=function(){O=!0},a.unstable_runWithPriority=function(U,W){switch(U){case 1:case 2:case 3:case 4:case 5:break;default:U=3}var ee=S;S=U;try{return W()}finally{S=ee}},a.unstable_scheduleCallback=function(U,W,ee){var K=a.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?K+ee:K):ee=K,U){case 1:var E=-1;break;case 2:E=250;break;case 5:E=1073741823;break;case 4:E=1e4;break;default:E=5e3}return E=ee+E,U={id:b++,callback:W,priorityLevel:U,startTime:ee,expirationTime:E,sortIndex:-1},ee>K?(U.sortIndex=ee,r(p,U),u(h)===null&&U===u(p)&&(B?(z(ae),ae=-1):B=!0,ze(Q,ee-K))):(U.sortIndex=E,r(h,U),_||w||(_=!0,te||(te=!0,Ue()))),U},a.unstable_shouldYield=he,a.unstable_wrapCallback=function(U){var W=S;return function(){var ee=S;S=W;try{return U.apply(this,arguments)}finally{S=ee}}}}(Ps)),Ps}var T0;function c1(){return T0||(T0=1,Ys.exports=o1()),Ys.exports}var Gs={exports:{}},zt={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var A0;function s1(){if(A0)return zt;A0=1;var a=wf();function r(h){var p="https://react.dev/errors/"+h;if(1<arguments.length){p+="?args[]="+encodeURIComponent(arguments[1]);for(var b=2;b<arguments.length;b++)p+="&args[]="+encodeURIComponent(arguments[b])}return"Minified React error #"+h+"; visit "+p+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(){}var c={d:{f:u,r:function(){throw Error(r(522))},D:u,C:u,L:u,m:u,X:u,S:u,M:u},p:0,findDOMNode:null},s=Symbol.for("react.portal");function d(h,p,b){var x=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:s,key:x==null?null:""+x,children:h,containerInfo:p,implementation:b}}var v=a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function y(h,p){if(h==="font")return"";if(typeof p=="string")return p==="use-credentials"?p:""}return zt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=c,zt.createPortal=function(h,p){var b=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!p||p.nodeType!==1&&p.nodeType!==9&&p.nodeType!==11)throw Error(r(299));return d(h,p,null,b)},zt.flushSync=function(h){var p=v.T,b=c.p;try{if(v.T=null,c.p=2,h)return h()}finally{v.T=p,c.p=b,c.d.f()}},zt.preconnect=function(h,p){typeof h=="string"&&(p?(p=p.crossOrigin,p=typeof p=="string"?p==="use-credentials"?p:"":void 0):p=null,c.d.C(h,p))},zt.prefetchDNS=function(h){typeof h=="string"&&c.d.D(h)},zt.preinit=function(h,p){if(typeof h=="string"&&p&&typeof p.as=="string"){var b=p.as,x=y(b,p.crossOrigin),S=typeof p.integrity=="string"?p.integrity:void 0,w=typeof p.fetchPriority=="string"?p.fetchPriority:void 0;b==="style"?c.d.S(h,typeof p.precedence=="string"?p.precedence:void 0,{crossOrigin:x,integrity:S,fetchPriority:w}):b==="script"&&c.d.X(h,{crossOrigin:x,integrity:S,fetchPriority:w,nonce:typeof p.nonce=="string"?p.nonce:void 0})}},zt.preinitModule=function(h,p){if(typeof h=="string")if(typeof p=="object"&&p!==null){if(p.as==null||p.as==="script"){var b=y(p.as,p.crossOrigin);c.d.M(h,{crossOrigin:b,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0})}}else p==null&&c.d.M(h)},zt.preload=function(h,p){if(typeof h=="string"&&typeof p=="object"&&p!==null&&typeof p.as=="string"){var b=p.as,x=y(b,p.crossOrigin);c.d.L(h,b,{crossOrigin:x,integrity:typeof p.integrity=="string"?p.integrity:void 0,nonce:typeof p.nonce=="string"?p.nonce:void 0,type:typeof p.type=="string"?p.type:void 0,fetchPriority:typeof p.fetchPriority=="string"?p.fetchPriority:void 0,referrerPolicy:typeof p.referrerPolicy=="string"?p.referrerPolicy:void 0,imageSrcSet:typeof p.imageSrcSet=="string"?p.imageSrcSet:void 0,imageSizes:typeof p.imageSizes=="string"?p.imageSizes:void 0,media:typeof p.media=="string"?p.media:void 0})}},zt.preloadModule=function(h,p){if(typeof h=="string")if(p){var b=y(p.as,p.crossOrigin);c.d.m(h,{as:typeof p.as=="string"&&p.as!=="script"?p.as:void 0,crossOrigin:b,integrity:typeof p.integrity=="string"?p.integrity:void 0})}else c.d.m(h)},zt.requestFormReset=function(h){c.d.r(h)},zt.unstable_batchedUpdates=function(h,p){return h(p)},zt.useFormState=function(h,p,b){return v.H.useFormState(h,p,b)},zt.useFormStatus=function(){return v.H.useHostTransitionStatus()},zt.version="19.1.0",zt}var M0;function zp(){if(M0)return Gs.exports;M0=1;function a(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(a)}catch(r){console.error(r)}}return a(),Gs.exports=s1(),Gs.exports}/**
 * @license React
...
`,Oo=a=>{let r=a;return r=r.replace("box-shadow: ",""),r=r.replace(";",""),r},Eb=(a,r)=>{return(u=a,Object.keys(u)).some(c=>a[c]!==r[c]);var u};function sg(a,r){const u={};return{observe(){u.rafId&&cancelAnimationFrame(u.rafId);const c=()=>{if(u.isObserving){const{scrollHeight:s,scrollLeft:d,scrollTop:v,scrollWidth:y}=a,{bottom:h,height:p,left:b,right:x,top:S,width:w,x:_,y:B}=a.getBoundingClientRect(),O={bottom:h,height:p,left:b,right:x,top:S,width:w,x:_||b,y:B||S,scrollHeight:s,scrollLeft:d,scrollTop:v,scrollWidth:y};Eb(O,u.rect||{})&&(u.rect=O,r(O)),u.rafId=requestAnimationFrame(c)}};u.rafId=requestAnimationFrame(c),u.isObserving=!0},unobserve(){u.rafId&&cancelAnimationFrame(u.rafId),u.isObserving&&(u.isObserving=!1)}}}var $b=zp();const _b=V.div`
  pointer-events: none;
  position: fixed;
  overflow: visible;
  z-index: var(--admiral-z-index-dropdown, ${({theme:a})=>a.zIndex.dropdown});
`,zf=({targetElement:a,rootRef:r,fullContainerWidth:u,...c})=>{const s=m.useRef(null);return m.useEffect(()=>{const d=s.current;if(d&&a){const v=sg(a,y=>{if(y){const{x:h,y:p,height:b,width:x}=y,{style:S}=d;S.top=`${p}px`,S.left=u?"0px":`${h}px`,S.height=`${b}px`,S.width=u?"100%":`${x}px`}});return v.observe(),()=>{v.unobserve()}}},[a,u]),$b.createPortal($.jsx(_b,{ref:s,...c}),(r==null?void 0:r.current)||document.body)};function Nb(a,r){const u=m.useRef(null),c=m.useRef(a);return m.useEffect(()=>{c.current=a},[a]),m.useEffect(()=>(u.current=setInterval(()=>c.current(),r),()=>clearInterval(u.current||0)),[r]),u}function ya(...a){return r=>{a.forEach(u=>{u&&(typeof u=="function"?u(r):u.current=r)})}}const Ri=m.createContext({}),wb=({rootRef:a,...r})=>{const[u,c]=m.useState([]),[s,d]=m.useState(void 0),v=m.useCallback(x=>{d(x)},[]),y=m.useCallback(x=>{d(S=>S===x?void 0:S)},[]),h=m.useCallback(x=>{c(S=>{const w=S.indexOf(x);return w>-1?S.slice(0,w):S})},[]),p=m.useCallback(x=>{c(S=>[...S,x])},[]),b=m.useMemo(()=>({addDropdown:p,removeDropdown:h,dropdowns:u,rootRef:a,activateMenu:v,deactivateMenu:y,currentActiveMenu:s}),[p,h,u,a,v,y,s]);return $.jsx(Ri.Provider,{value:b,children:r.children})};function fg(a){const{dropdowns:r=[],addDropdown:u,removeDropdown:c,activateMenu:s,deactivateMenu:d,currentActiveMenu:v}=m.useContext(Ri),y=r.indexOf(a);return{addDropdown:u,removeDropdown:c,dropdowns:y>-1?r.slice(y+1,r.length):[],activateMenu:s,deactivateMenu:d,currentActiveMenu:v}}const Tb=(a,r)=>!r.some(u=>u.current&&u.current.contains(a.target)),Ab=(a,r,u)=>{const c=a.bottom-a.top+8,s=r.top>=c,d=u-r.bottom>=c,v=r.top>=0&&r.bottom<=u,y=r.bottom<=0,h=r.top>=u,p=r.top<0&&0<r.bottom&&r.bottom<u,b=0<r.top&&r.top<u&&r.bottom>u;if(v){if(!s&&!d)return{upward:!1,translateY:u-r.bottom-c-16+"px"};if(s&&d)return{upward:!1,translateY:"0"};if(!s&&d)return{upward:!1,translateY:"0"};if(s&&!d)return{upward:!0,translateY:"0"}}else{if(y)return{upward:!1,translateY:0-r.bottom+8+"px"};if(h)return{upward:!0,translateY:u-r.top-8+"px"};if(p)return d?{upward:!1,translateY:"0"}:{upward:!1,translateY:0-r.bottom+8+"px"};if(b)return s?{upward:!0,translateY:"0"}:{upward:!0,translateY:""+(u-r.top-8)}}return{upward:!1,translateY:"0"}},Mb=(a,r,u)=>{const c=a.right-a.left,s=r.left>=0&&r.right<=u,d=r.right<=0,v=r.left>=u,y=r.left<0&&0<r.right&&r.right<u,h=r.right>u&&0<r.left&&r.left<u;if(s){const p=u-r.left>=c,b=r.right>=c,x=c>r.width;if(!b&&!p)return{align:"flex-end",translateX:u-r.right-16+"px"};if(b&&p)return{align:"flex-end",translateX:"0"};if(x&&!b&&p)return{align:"flex-start",translateX:"0"};if(x&&!p&&b)return{align:"flex-end",translateX:"0"}}else{if(d||y)return{align:"flex-start",translateX:0-r.left+16+"px"};if(v||h)return{align:"flex-end",translateX:u-r.right-16+"px"}}return{align:"",translateX:"0"}},Ob=V.div`
...
`,Db=V(zf)`
  ...
  flex-wrap: nowrap;
`,Bb=()=>null,Rf=m.forwardRef(({targetElement:a,onClickOutside:r=Bb,className:u="",alignSelf:c,dropContainerCssMixin:s,...d},v)=>{const y=m.useRef(null),[h,p]=m.useState(!1),{rootRef:b}=m.useContext(Ri);m.useLayoutEffect(()=>{var _;y.current!==document.activeElement&&((_=y==null?void 0:y.current)==null||_.focus())},[]);const x=m.useCallback(()=>{const _=y.current;if(_&&a){const B=_.getBoundingClientRect(),O=a.getBoundingClientRect(),A=globalThis.innerHeight,z=globalThis.innerWidth,{upward:L,translateY:J}=Ab(B,O,A);if(h!==L&&p(L),c&&c!=="auto")_.style.transform=`translateY(${J})`;else{const{align:Q,translateX:te}=Mb(B,O,z);_.style.transform=`translate(${te}, ${J})`,_.style.alignSelf=Q}}},[h,a]);Nb(x,100),m.useEffect(()=>{y.current&&(y.current.style.opacity="1")},[]);const[S,w]=m.useState(!1);return m.useEffect(()=>{function _(){w(!0)}return document.addEventListener("mousedown",_,!0),document.addEventListener("touchstart",_,!0),()=>{document.removeEventListener("mousedown",_,!0),document.removeEventListener("touchstart",_,!0)}},[]),m.useEffect(()=>{function _(B){r(B)}if(S)return document.addEventListener("mouseup",_),document.addEventListener("touchend",_),()=>{document.removeEventListener("mouseup",_),document.removeEventListener("touchend",_)}},[S]),$.jsx($.Fragment,{children:$.jsxs(Db,{targetElement:a,$reverse:h,rootRef:b,onMouseDown:()=>w(!1),children:[$.jsx(Cb,{}),$.jsx(Ob,{ref:ya(v,y),...d,className:u+" dropdown-container",$alignSelf:c,$dropContainerCssMixin:s})]})})});Rf.displayName="DropdownContainer";const zb=V(Rf)`
...
`;zb.displayName="StyledDropdownContainer";function Rb(...a){return r=>a.forEach(u=>function(c,s){typeof c=="function"?c(s):c!=null&&(c.current=s)}(u,r))}function sf(...a){return m.useCallback(Rb(...a),a)}function Hb(a){return m.forwardRef(a)}const jb=Y`
  overflow: scroll;
...
`,Zb=Hb(({children:a,verticalScrollProps:r,horizontalScrollProps:u,minThumbSize:c=20,contentBlockProps:s={},...d},v)=>{const y=m.useMemo(()=>s.id?s.id:`scroll-aria-${Math.random().toString(36).substring(2,12)}`,[s.id]),[h,p]=m.useState(null),b=sf(s.ref,x=>p(x));return $.jsxs(Lb,{ref:v,...d,children:[$.jsx(Ub,{...s,id:y,ref:b,children:a}),$.jsx(Fb,{contentNode:h,verticalScrollProps:r,horizontalScrollProps:u,minThumbSize:c})]})}),Fb=({verticalScrollProps:a={},horizontalScrollProps:r={},contentNode:u,minThumbSize:c=20})=>{const s=m.useMemo(()=>u!=null&&u.id?u==null?void 0:u.id:`scroll-aria-${Math.random().toString(36).substring(2,12)}`,[u==null?void 0:u.id]),[d,v]=m.useState(null),[y,h]=m.useState(null),[p,b]=m.useState(null),[x,S]=m.useState(null),[w,_]=m.useState(null),[B,O]=m.useState(null),[A,z]=m.useState(!1),[L,J]=m.useState(!1),[Q,te]=m.useState(0),[ae,de]=m.useState(0),[ne,he]=m.useState(0),[Be,Ue]=m.useState(0),[Me,pt]=m.useState(0),[ze,U]=m.useState(0),W=sf(a.ref,K=>v(K)),ee=sf(r.ref,K=>b(K));return m.useLayoutEffect(()=>{if(u&&w&&B&&d&&p&&y&&x){const{observe:K,unobserve:E}=sg(u,j=>{if(j){const Z=function(_t){const{clientHeight:Ke,scrollHeight:kt}=_t;return kt-Ke>=1}(u),X=function(_t){const{clientWidth:Ke,scrollWidth:kt}=_t;return kt-Ke>=1}(u),I=Math.min(Math.max(0,j.scrollTop),j.scrollHeight-j.height),fe=Math.min(Math.max(0,j.scrollLeft),j.scrollWidth-j.width);u.style.setProperty("--vertical-content-scroll",`${I}px`),u.style.setProperty("--horizontal-content-scroll",`${fe}px`),d.style.setProperty("display",Z?null:"none"),d.style.setProperty("bottom",X?"10px":null),p.style.setProperty("display",X?null:"none"),p.style.setProperty("right",Z?"10px":null);const ue=function(_t,Ke){const{clientHeight:kt,scrollHeight:jt}=_t,{clientHeight:tt}=Ke;return Math.max(Math.round(kt*tt/jt),c)}(u,y),Xe=function(_t,Ke){const{clientWidth:kt,scrollWidth:jt}=_t,{clientWidth:tt}=Ke;return Math.max(Math.round(kt*tt/jt),c)}(u,x);w.style.setProperty("--vertical-thumb-height",`${ue}px`),B.style.setProperty("--horizontal-thumb-width",`${Xe}px`);const{scrollTop:ye,scrollLeft:et,scrollHeight:Ot,scrollWidth:Qe}=u,{clientHeight:Re}=y,{clientWidth:Ht}=x,Ca=Math.round(Math.min(ye/Ot*Re,Re-ue)),ba=Math.round(Math.min(et/Qe*Ht,Ht-Xe));w.style.top=`${Ca}px`,B.style.left=`${ba}px`}});return K(),E}},[u,w,B,d,p,y,x]),m.useEffect(()=>{function K(j){j.preventDefault(),j.stopPropagation(),A&&z(!1),L&&J(!1)}function E(j){if(u){if(j.preventDefault(),j.stopPropagation(),A){const{scrollHeight:Z,clientHeight:X}=u,I=(j.clientY-Q)*(Z/X),fe=Math.round(Math.min(ne+I,Z-X));u.scrollTop=fe}if(L){const{scrollWidth:Z,clientWidth:X}=u,I=(j.clientX-ae)*(Z/X),fe=Math.round(Math.min(Be+I,Z-X));u.scrollLeft=fe}}}if(A||L)return document.addEventListener("mousemove",E),document.addEventListener("mouseup",K),()=>{document.removeEventListener("mousemove",E),document.removeEventListener("mouseup",K)}},[u,A,L,ne,Be,Q,ae]),m.useEffect(()=>{if(u){const{scrollHeight:K,clientHeight:E}=u,j=Math.round(Me*K-E/2);u.scrollTo({top:j,behavior:"smooth"})}},[Me]),m.useEffect(()=>{if(u){const{scrollWidth:K,clientWidth:E}=u,j=Math.round(ze*K-E/2);u.scrollTo({left:j,behavior:"smooth"})}},[ze]),m.useEffect(()=>{document.body.style.setProperty("cursor",A||L?"grabbing":null)},[A,L]),$.jsxs($.Fragment,{children:[$.jsxs(kb,{...a,ref:W,role:"scrollbar","aria-controls":s,children:[$.jsx(Xb,{onClick:function(K){if(K.preventDefault(),K.stopPropagation(),u){const{clientHeight:E}=u,{top:j}=u.getBoundingClientRect();pt((K.clientY-j)/E)}}}),$.jsx(Yb,{ref:K=>h(K),children:$.jsx(Qb,{ref:_,onMouseDown:function(K){K.preventDefault(),K.stopPropagation(),te(K.clientY),u&&he(u.scrollTop),z(!0)},style:{cursor:A?"grabbing":"grab"}})})]}),$.jsxs(qb,{...r,ref:ee,role:"scrollbar","aria-controls":s,children:[$.jsx(Gb,{onClick:function(K){if(K.preventDefault(),K.stopPropagation(),u){const{clientWidth:E}=u,{left:j}=u.getBoundingClientRect();U((K.clientX-j)/E)}}}),$.jsx(Pb,{ref:K=>S(K),children:$.jsx(Vb,{ref:O,onMouseDown:function(K){K.preventDefault(),K.stopPropagation(),de(K.clientX),u&&Ue(u.scrollLeft),J(!0)},style:{cursor:L?"grabbing":"grab"}})})]})]})},Kb=Y`
...
`;var F0;function ff(){return ff=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},ff.apply(null,arguments)}var eS=function(a){return m.createElement("svg",ff({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),F0||(F0=m.createElement("path",{fill:"#74767B",fillRule:"evenodd",d:"M9.99 16.21c-.18 0-.35-.07-.48-.21a.66.66 0 0 1 .04-.92l3.49-3.15-3.48-3.02a.65.65 0 0 1-.04-.92c.24-.26.65-.28.92-.04l3.97 3.46c.31.28.31.76 0 1.04l-3.98 3.59c-.13.12-.28.17-.44.17"})))};const tS=V(eS)`
  transition: all 0.3s;
  flex-shrink: 0;
  width: 24px;
  height: 24px;
...
`,aS=a=>{a.preventDefault(),a.stopPropagation()},Hf=m.forwardRef(({children:a,expandIcon:r=$.jsx(tS,{}),hasSubmenu:u,onHover:c,disabled:s,readOnly:d,hovered:v,dimension:y="l",selected:h=!1,preselected:p=!1,selfRef:b,onMouseDown:x,onLeave:S,containerRef:w,..._},B)=>{const O=s?aS:x,A=b?ya(B,b):B;return $.jsxs(lS,{ref:A,$dimension:y,$preselected:p,$selected:h,$hovered:v,"data-preselected":p,"data-hovered":v,"data-disabled":s,"data-readonly":d,"data-dimension":y,onMouseEnter:z=>{var L;c==null||c(z),(L=_.onMouseEnter)==null||L.call(_,z)},onMouseLeave:z=>{var L;S==null||S(z),(L=_.onMouseLeave)==null||L.call(_,z)},onMouseMove:z=>{var L;c==null||c(z),(L=_.onMouseMove)==null||L.call(_,z)},onMouseDown:O,..._,children:[m.Children.toArray(a).map((z,L)=>typeof z=="string"?$.jsx(nS,{children:z},z+L):z),u&&r]})});Hf.displayName="MenuItem";const lS=V.div`
  display: flex;
  align-items: center;
  user-select: none;
  position: relative;
...
`;function jf(a){const r=m.useRef();return m.useEffect(()=>{r.current=a}),r.current}const K0=V.div`
  display: flex;
  flex: 0 0 auto;
`,rS=({scrollContainerRef:a,itemHeight:r,rowCount:u=6,aheadItemsCount:c=3,model:s,activeId:d,selected:v,onRenderItem:y})=>{const[h,p]=m.useState(0),[b,x]=m.useState({startIndex:0,endIndex:u,topPadding:"",bottomPadding:"",needAddListener:!1}),S=jf({activeId:d}),w=m.useCallback(O=>{requestAnimationFrame(()=>{O.target&&p(O.target.scrollTop)})},[a]);m.useEffect(()=>{const O=a.current;return p((O==null?void 0:O.scrollTop)||0),O==null||O.addEventListener("scroll",w),()=>O==null?void 0:O.removeEventListener("scroll",w)},[w]),m.useEffect(()=>{b.needAddListener&&(setTimeout(()=>{var O;return(O=a==null?void 0:a.current)==null?void 0:O.addEventListener("scroll",w)}),x({...b,needAddListener:!1}))},[b,a]);const _=m.useCallback(O=>{const A=s.length,z=Math.max(0,O);let L=u+2*c;return L=Math.min(A-z,L),{startIndex:z,endIndex:z+L,topPadding:z*r+"px",bottomPadding:(A-z-L)*r+"px"}},[r,c,s,u]);m.useEffect(()=>{const O=Math.floor(h/r-c),A={..._(O),needAddListener:!1};x(A)},[h,_]),m.useEffect(()=>{var A;if(!d||!S||S.activeId===d)return;const O=s.findIndex(z=>z.id===d);O!==-1&&(O<b.startIndex||O>b.endIndex)&&((A=a==null?void 0:a.current)==null||A.removeEventListener("scroll",w),x({..._(O),needAddListener:!0}))},[d,b,_,a]);const B=m.useMemo(()=>[...s].slice(b.startIndex,b.endIndex).map((O,A)=>y==null?void 0:y(O,A)),[s,d,v,b]);return $.jsxs($.Fragment,{children:[$.jsx(K0,{style:{minHeight:b.topPadding}}),B,$.jsx(K0,{style:{minHeight:b.bottomPadding}})]})},dg=(a,r)=>{const u=m.useCallback(c=>{a.every(s=>s.current&&!s.current.contains(c.target))&&r(c)},[r,a]);m.useEffect(()=>(document.addEventListener("mousedown",u,!0),document.addEventListener("touchstart",u),()=>{document.removeEventListener("mousedown",u,!0),document.removeEventListener("touchstart",u)}),[u])},iS=(a,r)=>{let u,c=!1,s=!1;return[(...d)=>{if(s||c)return;const v=a(...d);return c=!0,u=setTimeout(()=>{c=!1},r),v},()=>{s=!0,clearTimeout(u)}]};function uS(a,r,u){const c=a.getBoundingClientRect(),s=r.getBoundingClientRect(),d=document.documentElement.clientWidth-c.right>s.width,v=c.left>s.width,y=u==="right"?!d&&v?"left":"right":!v&&d?"right":"left";return document.documentElement.clientHeight-c.top>s.height-1?{position:`${y}Bottom`}:{position:y,bottomOffset:8-(document.documentElement.clientHeight-c.top-s.height)}}const hg=(a,r)=>{for(let u=0;u<a.length;u++){const c=a[u];if(c.id===r)return c;if(c.subItems&&c.subItems.length>0){const s=hg(c.subItems,r);if(s)return s}}},mg=(a,r)=>!!a.subItems&&a.subItems.some(u=>r.includes(u.id)||mg(u,r)),W0=a=>Array.isArray(a)?[...a]:[a],oS=V.div`
...
`,dS=V.div`
  ...
  overflow: hidden;
  box-sizing: border-box;
`,pg=({targetElement:a,children:r,onClickOutside:u,defaultRenderDirection:c="right",...s})=>{const{rootRef:d}=m.useContext(Ri),v=m.useRef(null),[y,h]=m.useState(null),[p,b]=m.useState("row");m.useLayoutEffect(()=>{const[_,B]=iS(()=>{h({})},100);return addEventListener("resize",_),addEventListener("scroll",_),()=>{removeEventListener("resize",_),removeEventListener("scroll",_),B()}});const{addDropdown:x,removeDropdown:S,dropdowns:w}=fg(v);return m.useLayoutEffect(()=>(x==null||x(v),()=>{S==null||S(v)}),[]),dg([v],_=>{a&&!a.contains(_.target)&&Tb(_,w)&&(u==null||u(_))}),m.useLayoutEffect(()=>{const _=v.current;if(a&&_){const{position:B,bottomOffset:O=0}=uS(a,_,c);switch(B){case"right":b("row"),_.style.bottom=`${O}px`;break;case"left":b("row-reverse"),_.style.bottom=`${O}px`;break;case"rightBottom":default:b("row"),_.style.bottom="8px";break;case"leftBottom":b("row-reverse"),_.style.bottom="8px"}}},[a,y]),a&&$.jsx(oS,{children:$.jsxs(cS,{targetElement:a,rootRef:d,$flexDirection:p,fullContainerWidth:!1,children:[$.jsx(sS,{}),$.jsx(fS,{ref:v,...s,children:$.jsx(dS,{children:r})})]})})};pg.displayName="SubMenu";const gg=a=>{switch(a){case"l":default:return 48;case"m":return 40;case"s":return 32}},hS=Y`
...
`,Lf=m.forwardRef(({model:a,defaultSelected:r,selected:u,preselected:c,active:s,onPreselectItem:d,onSelectItem:v,onDeselectItem:y,onActivateItem:h,renderTopPanel:p,renderBottomPanel:b,dimension:x="l",multiSelection:S=!1,disableSelectedOptionHighlight:w=!1,onForwardCycleApprove:_,onBackwardCycleApprove:B,containerRef:O,virtualScroll:A,rowCount:z=6,parentMenuRef:L,onCloseQuery:J,defaultIsActive:Q=!0,subMenuRenderDirection:te,preventFocusSteal:ae,maxHeight:de,preselectedModeActive:ne=!1,onMenuKeyDown:he,disableSelectionOnSpace:Be,disableSelectionOnEnter:Ue,...Me},pt)=>{const ze=re=>{const ce=re?a.findIndex(Ze=>Ze.id===re):-1;let ve=ce<a.length-1?ce+1:0,Oe=!1;for(;(a[ve].disabled||a[ve].readOnly)&&!Oe;)ve=ve<a.length-1?ve+1:0,Oe=ce===-1?ve===0:ve===ce;return ve=!(ce>-1&&ve<ce)||!_||_()?ve:ce,a[ve].disabled||a[ve].readOnly?void 0:a[ve].id},U=a.length>0?ze():void 0,[W,ee]=m.useState(r?W0(r):[]),[K,E]=m.useState(U),[j,Z]=m.useState(U),X=m.useRef(null),I=m.useRef(null),[fe,ue]=m.useState(null),[Xe,ye]=m.useState(!1),et=m.useRef();m.useEffect(()=>{E(U)},[a]);const Ot=w?[]:u===void 0?W:W0(u),Qe=s===void 0?K:s,Re=ne?c===void 0?j:c:void 0,Ht=m.useRef(null),Ca=m.useRef(null),ba=!!p,_t=!!b,Ke=re=>{Qe!==re&&E(re),h==null||h(re)},kt=re=>{Re!==re&&Z(re),d==null||d(re)},jt=re=>{const ce=hg(a,re);if(ce&&!ce.disabled&&!ce.readOnly){const ve=W.findIndex(Oe=>Oe===re);S?ve>-1?(ee(W.splice(ve,1)),y==null||y(re)):(ee([...W,re]),v==null||v(re)):(ve===-1&&ee([re]),v==null||v(re))}},{currentActiveMenu:tt,activateMenu:nt,deactivateMenu:Sa}=fg(X);m.useEffect(()=>{function re(ce){if((tt==null?void 0:tt.current)===X.current)switch(G.getCode(ce)){case G[" "]:if(Be)break;ne&&Re?jt(Re):Qe&&jt(Qe),ce.preventDefault();break;case G.Enter:if(Ue)break;ne&&Re?jt(Re):Qe&&jt(Qe),ce.preventDefault();break;case G.ArrowDown:{const ve=ze(ne&&Re||Qe);ne?kt(ve):Ke(ve),ce.preventDefault();break}case G.ArrowUp:{const ve=(Oe=>{const Ze=Oe?a.findIndex(we=>we.id===Oe):-1;let He=Ze>0?Ze-1:a.length-1,Vt=!1;for(;(a[He].disabled||a[He].readOnly)&&!Vt;)He=He>0?He-1:a.length-1,Vt=Ze===-1?He===0:He===Ze;return He=Ze>-1&&He>Ze&&B&&!B()?Ze:He,a[He].disabled||a[He].readOnly?void 0:a[He].id})(ne&&Re||Qe);ne?kt(ve):Ke(ve),ce.preventDefault();break}case G.ArrowRight:{const ve=ne&&Re||Qe,Oe=a.find(Ze=>Ze.id===ve);!Oe||Oe.disabled||Oe.readOnly||!Oe.subItems||Xe||ye(!0),I&&I.current&&(nt==null||nt(I));break}case G.ArrowLeft:L&&L.current&&(J==null||J());break;default:he==null||he(ce)}}return document.addEventListener("keydown",re),()=>{document.removeEventListener("keydown",re)}},[s,Qe,K,tt,Re,Be,Ue]),m.useEffect(()=>(Q&&(nt==null||nt(X)),()=>{Q&&tt===X&&(Sa==null||Sa(X))}),[Q]);const bn=()=>{ye(!1),nt==null||nt(X)},ke=(re,ce)=>{const{id:ve,subItems:Oe,render:Ze,...He}=re,Vt=!!Oe&&Oe.length>0,we=Qe===ve,Xt=Ot.includes(ve)||mg(re,Ot),Qt={hovered:we,preselected:Re!==void 0?Re===ve:void 0,selected:Xt,onLeave:la=>{var Zt,fl;const na=la.relatedTarget;na&&Object.hasOwn(na,"nodeName")&&!((Zt=I.current)!=null&&Zt.contains(na))&&!((fl=Ca.current)!=null&&fl.contains(na))&&ye(!1)},onHover:la=>{Ke(ve),ye(Vt),ue(la.currentTarget)},onMouseDown:ae?la=>la.preventDefault():void 0,onClick:()=>jt(ve),hasSubmenu:Vt,disabled:He.disabled,...He};return typeof Ze=="function"?Ze({containerRef:O,...Qt}):$.jsx(Hf,{...Qt,children:Ze},`${re.id}-${ce}`)},Yl=m.useRef(),Da=m.useRef(),bt=m.useRef(),Je=m.useRef();m.useLayoutEffect(()=>{setTimeout(()=>{var ce,ve;let re;if(s&&Yl.current!==s||Da.current!==K?re=(ce=Ht.current)==null?void 0:ce.querySelector('[data-hovered="true"]'):(c&&bt.current!==c||Je.current!==j)&&(re=(ve=Ht.current)==null?void 0:ve.querySelector('[data-preselected="true"]')),re){const Oe=Date.now(),Ze=et.current;re==null||re.scrollIntoView({behavior:!Ze||Oe-Ze<150?"auto":"smooth",inline:"center",block:"nearest"}),et.current=Oe,Yl.current=s,Da.current=K,bt.current=c,Je.current=j}},0)},[s,K,c,j,a]);const st=cg(Me);return m.useEffect(()=>{if(!fe||!Ht.current)return;const re={root:Ht.current,rootMargin:"0px",threshold:.5},ce=new IntersectionObserver(ve=>{ve.forEach(Oe=>{ye(!(Oe.intersectionRatio<re.threshold))})},re);return ce.observe(fe),()=>ce.disconnect()},[fe]),$.jsxs(mS,{ref:ya(X,pt),$dimension:x,$hasTopPanel:ba,$hasBottomPanel:_t,onMouseEnter:re=>{var ce;tt!==X&&(nt==null||nt(X)),(ce=Me.onMouseEnter)==null||ce.call(Me,re)},onMouseLeave:re=>{var ce;Ke(void 0),(ce=Me.onMouseLeave)==null||ce.call(Me,re)},onFocus:re=>{var ce;tt!==X&&(nt==null||nt(X)),(ce=Me.onFocus)==null||ce.call(Me,re)},onBlur:re=>{var ce;tt===X&&(Sa==null||Sa(X)),(ce=Me.onBlur)==null||ce.call(Me,re)},...Me,children:[ba&&p({dimension:x}),$.jsx(pS,{$dimension:x,$rowCount:z,$hasTopPanel:ba,$hasBottomPanel:_t,$maxHeight:de,...st,verticalScrollProps:{ref:Ca},contentBlockProps:{ref:Ht},children:A?(()=>{if(!A)return null;const re=A.itemHeight==="auto"?gg(x):A.itemHeight;return $.jsx(rS,{scrollContainerRef:Ht,itemHeight:re,model:a,rowCount:z,activeId:Qe,selected:Ot,onRenderItem:ke})})():a.map((re,ce)=>ke({dimension:x,...re},ce))}),Xe&&fe&&$.jsx(pg,{targetElement:fe,defaultRenderDirection:te,onClickOutside:L?void 0:()=>{ye(!1)},children:(()=>{const re=a.find(ce=>ce.id===Qe);return re&&re.subItems&&re.subItems.length>0&&$.jsx(Lf,{ref:I,dimension:x,parentMenuRef:X,model:re.subItems,subMenuRenderDirection:te,onCloseQuery:bn,selected:Ot,onSelectItem:ce=>jt(ce),virtualScroll:A,preventFocusSteal:!0})})()}),_t&&b({dimension:x})]})});Lf.displayName="Menu";var J0;function df(){return df=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},df.apply(null,arguments)}var Uf=function(a){return m.createElement("svg",df({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),J0||(J0=m.createElement("path",{fill:"#74767B",d:"M6.4 5.49a.63.63 0 0 0-.91 0c-.26.25-.26.66 0 .91l5.59 5.59-5.49 5.5c-.26.25-.26.66 0 .91.25.26.66.26.91 0l5.5-5.49 5.49 5.49c.25.26.66.26.91 0 .26-.25.26-.66 0-.91l-5.49-5.5L18.5 6.4c.26-.25.26-.66 0-.91a.63.63 0 0 0-.91 0L12 11.08z"})))};function Mi(a){switch(a){case"lSmall":case"lBig":default:return 24;case"mSmall":case"mBig":return 20;case"s":return 16}}function vg(a){switch(a){case"lBig":case"mBig":default:return 6;case"lSmall":case"mSmall":case"s":return 4}}function I0(a){return Mi(a)+2*vg(a)}const gS=Y`
  & *[fill^='#'] {
...
`,vS=V.div`
  ...
  & > svg {
    height: ${a=>Mi(a.$dimension)}px;
    width: ${a=>Mi(a.$dimension)}px;
  }
`,_i=V.div`
...
`,SS=m.forwardRef(({type:a="button",dimension:r="lBig",disabled:u=!1,highlightFocus:c=!0,appearance:s,children:d,...v},y)=>{const h=typeof s=="object"?s.iconColor?s.iconColor:"secondary":s;return $.jsxs(bS,{ref:y,type:a,$dimension:r,disabled:u,$highlightFocus:c,...v,children:[$.jsx(_i,{$dimension:r,"aria-hidden":!0}),$.jsx(vS,{$dimension:r,$iconColor:h,"aria-hidden":!0,children:d})]})}),xS=m.forwardRef(({className:a,...r},u)=>$.jsx(SS,{ref:u,className:`close-button ${a||""}`,...r,children:$.jsx(Uf,{"aria-hidden":!0})}));var ep,tp,ap,lp,np,rp;function hf(){return hf=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},hf.apply(null,arguments)}var ES=function(a){return m.createElement("svg",hf({xmlns:"http://www.w3.org/2000/svg",fill:"none"},a),ep||(ep=m.createElement("style",null,"@container (min-width: 64px){svg path.Subtract_svg__spinner-icon:not([data-dimension=xl]){display:none}}@container (max-width: 48px) and (min-width: 25px){svg path.Subtract_svg__spinner-icon:not([data-dimension=l]){display:none}}@container (max-width: 24px) and (min-width: 21px){svg path.Subtract_svg__spinner-icon:not([data-dimension=m]){display:none}}@container (max-width: 20px) and (min-width: 17px){svg path.Subtract_svg__spinner-icon:not([data-dimension=ms]){display:none}}@container (max-width: 16px){svg path.Subtract_svg__spinner-icon:not([data-dimension=s]){display:none}}")),tp||(tp=m.createElement("path",{fillRule:"evenodd",d:"M58.607 49.778a32 32 0 0 0 5.252-14.782C64.016 33.346 62.658 32 61 32s-2.982 1.349-3.17 2.995C56.343 47.944 45.346 58 32 58 17.64 58 6 46.36 6 32 6 18.654 16.056 7.656 29.005 6.17 30.651 5.983 32 4.658 32 3S30.654-.015 29.004.14a32 32 0 1 0 29.603 49.638",className:"Subtract_svg__spinner-icon",clipRule:"evenodd","data-dimension":"xl"})),ap||(ap=m.createElement("path",{fillRule:"evenodd",d:"M43.955 37.334a24 24 0 0 0 3.915-10.838C48.014 25.122 46.88 24 45.5 24s-2.483 1.125-2.662 2.494C41.616 35.81 33.648 43 24 43 13.507 43 5 34.493 5 24c0-9.648 7.191-17.616 16.506-18.838C22.875 4.982 24 3.881 24 2.5c0-1.38-1.122-2.513-2.496-2.37a24 24 0 1 0 22.451 37.204",className:"Subtract_svg__spinner-icon",clipRule:"evenodd","data-dimension":"l"})),lp||(lp=m.createElement("path",{fillRule:"evenodd",d:"M21.978 18.667a12 12 0 0 0 1.928-5.17C24.01 12.673 23.328 12 22.5 12s-1.487.677-1.623 1.494C20.165 17.754 16.462 21 12 21a9 9 0 0 1-1.494-17.877C11.323 2.987 12 2.328 12 1.5S11.326-.01 10.504.094a12 12 0 1 0 11.474 18.573",className:"Subtract_svg__spinner-icon",clipRule:"evenodd","data-dimension":"m"})),np||(np=m.createElement("path",{fillRule:"evenodd",d:"M18.378 15.54a10 10 0 0 0 1.613-4.324c.087-.687-.483-1.25-1.176-1.25-.692 0-1.243.565-1.357 1.248a7.526 7.526 0 1 1-8.672-8.672c.683-.114 1.249-.665 1.249-1.357 0-.693-.564-1.263-1.251-1.176a10.035 10.035 0 1 0 9.594 15.531",className:"Subtract_svg__spinner-icon",clipRule:"evenodd","data-dimension":"ms"})),rp||(rp=m.createElement("path",{fillRule:"evenodd",d:"M14.652 12.445a8 8 0 0 0 1.286-3.448C16.006 8.45 15.552 8 15 8s-.991.451-1.082.996A6.002 6.002 0 0 1 2 8a6 6 0 0 1 5.004-5.918C7.55 1.992 8 1.552 8 1S7.55-.006 7.003.062a8 8 0 1 0 7.649 12.383",className:"Subtract_svg__spinner-icon",clipRule:"evenodd","data-dimension":"s"})))};const $S=ug`
  0% {
...
`;function OS(a,r,u,c){const s=a.getBoundingClientRect(),d=r.getBoundingClientRect(),v=Object.entries(function(p){return{bottom:{check:(b,x)=>{const S=globalThis.innerHeight-b.bottom-p>8+x.height,w=b.left+b.width/2>x.width/2,_=globalThis.innerWidth-b.right-p+b.width/2>x.width/2;return S&&w&&_}},top:{check:(b,x)=>{const S=b.top>8+x.height,w=b.left+b.width/2>x.width/2,_=globalThis.innerWidth-b.right-p+b.width/2>x.width/2;return S&&w&&_}},left:{check:(b,x)=>{const S=b.left>8+x.width,w=b.top>(x.height-b.height)/2,_=globalThis.innerHeight-b.bottom-p>(x.height-b.height)/2;return S&&_&&w}},right:{check:(b,x)=>{const S=globalThis.innerWidth-b.right-p>8+x.width,w=b.top>(x.height-b.height)/2,_=globalThis.innerHeight-b.bottom-p>(x.height-b.height)/2;return S&&_&&w}},bottomRight:{check:(b,x)=>{const S=globalThis.innerHeight-b.bottom-p>8+x.height,w=globalThis.innerWidth-b.left-p>x.width;return S&&w}},bottomLeft:{check:(b,x)=>{const S=globalThis.innerHeight-b.bottom-p>8+x.height,w=b.right>x.width;return S&&w}},topRight:{check:(b,x)=>{const S=b.top>8+x.height,w=globalThis.innerWidth-b.left-p>x.width;return S&&w}},topLeft:{check:(b,x)=>{const S=b.top>8+x.height,w=b.right>x.width;return S&&w}},leftBottom:{check:(b,x)=>{const S=b.left>8+x.width,w=globalThis.innerHeight-b.top-p>x.height;return S&&w}},leftTop:{check:(b,x)=>{const S=b.left>8+x.width,w=b.bottom>x.height;return S&&w}},rightBottom:{check:(b,x)=>{const S=globalThis.innerWidth-b.right-p>8+x.width,w=globalThis.innerHeight-b.top-p>x.height;return S&&w}},rightTop:{check:(b,x)=>{const S=globalThis.innerWidth-b.right-p>8+x.width,w=b.bottom>x.height;return S&&w}},bottomPageCenter:{check:(b,x)=>{const S=globalThis.innerHeight-b.bottom-p>8+x.height,w=globalThis.innerWidth-p>=x.width;return S&&w}},topPageCenter:{check:(b,x)=>{const S=b.top>8+x.height,w=globalThis.innerWidth-p>=x.width;return S&&w}}}}(u)),y=c?v.filter(p=>p[0].includes(c)&&p[1].check(s,d)):v.filter(p=>p[1].check(s,d)),h=c||"bottom";return y.length?y[0][0]:h}const Hi=m.forwardRef(({dimension:a="m",renderContent:r,targetElement:u,tooltipPosition:c,...s},d)=>{const v=m.useRef(null),y=m.useRef(0),{rootRef:h}=m.useContext(Ri),p=m.useMemo(()=>!r()&&r()!==0,[r]),[b,x]=m.useState(),[S,w]=m.useState(!1),[_,B]=m.useState({});return m.useEffect(()=>{(O=>{const A=u;if(A&&v.current){const z=OS(A,v.current,O,c),L=v.current;switch(z){case"leftBottom":case"leftTop":case"left":x("row-reverse"),w(!1),L.style.margin="0 8px 0 0",L.style.alignSelf=z==="leftBottom"?"flex-start":z==="leftTop"?"flex-end":"center";break;case"rightBottom":case"rightTop":case"right":x("row"),w(!1),L.style.margin="0 0 0 8px",L.style.alignSelf=z==="rightBottom"?"flex-start":z==="rightTop"?"flex-end":"center";break;case"topPageCenter":case"topLeft":case"topRight":case"top":x("column-reverse"),w(z==="topPageCenter"),L.style.margin="0 0 8px 0",L.style.alignSelf=z==="topLeft"?"flex-end":z==="topRight"?"flex-start":"center";break;default:x("column"),w(z==="bottomPageCenter"),L.style.margin="8px 0 0 0",L.style.alignSelf=z==="bottomLeft"?"flex-end":z==="bottomRight"?"flex-start":"center"}}})(NS())},[r(),u,c,_]),m.useLayoutEffect(()=>{if(v.current&&!p){const O=new ResizeObserver(A=>{A.forEach(z=>{y.current===0?y.current=z.contentRect.height:B({})})});return O.observe(v.current),()=>{O.disconnect()}}},[p]),m.useEffect(()=>{v.current&&!p&&(v.current.style.opacity="1")},[p]),p?null:$.jsxs(MS,{targetElement:u,rootRef:h,$flexDirection:b,fullContainerWidth:S,children:[$.jsx(AS,{}),$.jsx(wS,{ref:ya(d,v),children:$.jsx(TS,{role:"tooltip",$dimension:a,...s,children:r()})})]})});Hi.displayName="Tooltip";const CS=Y`
...
`,BS=V.div`
  ...
  ${DS}
  user-select: none;
`,kf=m.forwardRef(({children:a,dimension:r="m",appearance:u="light",locale:c,...s},d)=>{const v=rg()||Df,y=(c==null?void 0:c.amountAriaLabel)||v.locales[v.currentLocale].badge.amountAriaLabel;return $.jsx(BS,{ref:d,$dimension:r,$appearance:u,"aria-label":`${y} ${a}`,...s,children:a})});kf.displayName="Badge";V(kf)`
...
`,sp=V.div`
  display: inline-block;
  width: 2px;
`,mr=m.forwardRef(({appearance:a="primary",dimension:r="xl",type:u="button",loading:c=!1,skeleton:s=!1,iconStart:d,iconEnd:v,icon:y,iconPlace:h="left",children:p,buttonCssMixin:b,displayAsDisabled:x,displayAsSquare:S,...w},_)=>{const B=!!d||!!y&&h==="left",O=!!v||!!y&&h==="right",A=(S||B?0:2)+(S||O?0:2);return $.jsxs(YS,{ref:_,$appearance:a,$dimension:r,type:u,$loading:c,$skeleton:s,$buttonCssMixin:b,$displayAsSquare:S,$displayAsDisabled:x,...w,children:[c&&$.jsx(qS,{children:$.jsx(yg,{$inverse:a!=="secondary"&&a!=="tertiary"&&a!=="ghost"})}),!S&&!B&&$.jsx(sp,{}),$.jsxs(Sg,{$addPadding:A,children:[B?$.jsx(hr,{children:d||y}):null,m.Children.toArray(p).map((z,L)=>typeof z=="string"?$.jsx("div",{children:z},z+L):z),O?$.jsx(hr,{children:v||y}):null]}),!S&&!O&&$.jsx(sp,{})]})}),YS=V.button.attrs(a=>({"data-dimension":a.$dimension,"data-appearance":[a.$appearance,a.$displayAsDisabled?"disabled":void 0].filter(r=>r!==void 0).join(" ")}))`
  position: relative;
  box-sizing: border-box;
  display: inline-block;
  white-space: nowrap;
...
`;mr.displayName="Button";var fp;function mf(){return mf=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},mf.apply(null,arguments)}var PS=function(a){return m.createElement("svg",mf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 16 16"},a),fp||(fp=m.createElement("path",{fill:"#fff",d:"M13.471 5.805a.667.667 0 1 0-.942-.943L7 10.39 4.138 7.53a.667.667 0 0 0-.943.942l3.334 3.334c.26.26.682.26.942 0z"})))},dp;function pf(){return pf=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},pf.apply(null,arguments)}var GS=function(a){return m.createElement("svg",pf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"-5 -9 20 20"},a),dp||(dp=m.createElement("rect",{width:10,height:2,fill:"#fff",rx:1})))};const VS=Y`
...
`,_g=m.forwardRef(({className:a,dimension:r="m",disabled:u,readOnly:c,hovered:s,indeterminate:d,error:v,...y},h)=>$.jsxs(FS,{$dimension:r,$disabled:u,$readOnly:c,className:a,children:[$.jsx(IS,{ref:h,disabled:u,readOnly:c,...y,type:"checkbox",$indeterminate:d,onKeyDown:p=>{var b;c&&G.getCode(p)===G[" "]&&p.preventDefault(),(b=y.onKeyDown)==null||b.call(y,p)},"data-hovered":s,$hovered:s}),$.jsx(hn,{$error:v,children:$.jsx(d?ZS:QS,{"aria-hidden":"true",focusable:"false"})})]}));_g.displayName="Checkbox";function ji(){return(performance.now().toString(36)+Math.random().toString(36)).replace(/\./g,"")}const ex=Y`
...
`,lx=V.div`
  ...
  overflow: hidden;
`,nx=({maxLength:a,visibilityThreshold:r=.8,inputRef:u,...c})=>{const[s,d]=m.useState(0);return m.useEffect(()=>{const v=setInterval(()=>{const y=u.current;y&&d(y.value.length)},250);return()=>clearInterval(v)},[u]),s>=a*r?$.jsxs(lx,{...c,$error:s>=a,$transparent:s<a*r,children:[s," / ",a]}):null},Yf=V.label`
  display: block;
  text-align: left;
...
`,mx=V(nx)`
  flex: 0 0 auto;
  padding: 8px 0 0 8px;
`,Pf=m.forwardRef(({children:a,maxLength:r,inputRef:u,displayCharacterCounter:c=!0,characterCounterVisibilityThreshold:s=.8,...d},v)=>{const y=m.useRef(null),[h,p]=m.useState(!1),{className:b,style:x,displayInline:S,status:w,extraText:_,label:B,required:O,disabled:A,id:z,skeleton:L=!1,...J}=d,[Q]=m.useState(ji()),te={className:b,style:x,...J},ae={htmlFor:z??Q,children:B,required:O,disabled:A};return m.useEffect(()=>{const de=()=>{p(!0)},ne=()=>{p(!1)},he=y.current;return he&&(he.addEventListener("focusin",de),he.addEventListener("focusout",ne)),()=>{he&&(he.removeEventListener("focusin",de),he.removeEventListener("focusout",ne))}},[]),$.jsxs(ix,{...te,$displayInline:S,"data-status":w,"data-focus-within":h?"":void 0,"data-required-within":O?"":void 0,"data-disabled":A?"":void 0,"data-read-only":!!d.readOnly||void 0,ref:ya(y,v),children:[ae.children&&$.jsxs(ox,{children:[L&&$.jsx(ux,{}),$.jsx(sx,{$skeleton:L,...ae})]}),$.jsxs(Ng,{children:[a,$.jsxs(dx,{$skeleton:L,children:[_&&$.jsx(hx,{children:_}),c&&u&&r!==void 0&&$.jsxs($.Fragment,{children:[$.jsx("div",{}),$.jsx(mx,{maxLength:r,visibilityThreshold:s,inputRef:u})]})]})]})]})});Pf.displayName="Field";function vf(a,r){return a.value!==r.value||a.selectionStart!==r.selectionStart||a.selectionEnd!==r.selectionEnd}function ol(a,r){var d;const{value:u=a.value,selectionStart:c,selectionEnd:s}=r;if(vf(a,{value:u,selectionStart:c,selectionEnd:s})){const v=(d=Object.getOwnPropertyDescriptor(Object.getPrototypeOf(a),"value"))==null?void 0:d.set;let y;v==null||v.call(a,u),typeof c=="number"&&typeof s=="number"&&a.setSelectionRange(c,s),typeof Event=="function"?y=new Event("input",{bubbles:!0}):(y=document.createEvent("Event"),y.initEvent("input",!0,!0)),a.dispatchEvent(y)}}var pp;function yf(){return yf=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},yf.apply(null,arguments)}var px=function(a){return m.createElement("svg",yf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),pp||(pp=m.createElement("path",{fill:"#74767B",d:"M21.7 10.04c.29.2.38.6.18.9-.5.75-1.14 1.57-1.92 2.36l1.84 1.84c.25.25.25.66 0 .91a.64.64 0 0 1-.92 0l-1.87-1.86c-.93.8-2.01 1.51-3.22 2.02l1.03 2.49a.65.65 0 0 1-1.2.5l-1.06-2.56a9.7 9.7 0 0 1-5.13.01L8.37 19.2a.65.65 0 0 1-1.2-.5l1.03-2.47c-1.25-.52-2.32-1.25-3.23-2.04l-1.86 1.86a.64.64 0 0 1-.92 0 .646.646 0 0 1 0-.91l1.84-1.85c-.8-.83-1.43-1.67-1.9-2.34-.2-.29-.13-.7.16-.9.3-.21.7-.13.91.16 1.46 2.1 4.34 5.48 8.8 5.48 4.03 0 7.14-2.98 8.79-5.47.2-.3.61-.38.91-.18"})))},gp;function bf(){return bf=Object.assign?Object.assign.bind():function(a){for(var r=1;r<arguments.length;r++){var u=arguments[r];for(var c in u)({}).hasOwnProperty.call(u,c)&&(a[c]=u[c])}return a},bf.apply(null,arguments)}var gx=function(a){return m.createElement("svg",bf({xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24"},a),gp||(gp=m.createElement("path",{fill:"#74767B",fillRule:"evenodd",d:"M2.43 10.68C3.86 8.65 7.11 5 12 5c4.88 0 8.13 3.65 9.56 5.68.56.8.56 1.83 0 2.63C20.13 15.34 16.88 19 12 19c-4.89 0-8.14-3.66-9.57-5.69-.56-.8-.56-1.83 0-2.63M6.29 12c0 3.14 2.56 5.7 5.71 5.7 3.14 0 5.7-2.56 5.7-5.7 0-3.15-2.56-5.71-5.7-5.71-3.15 0-5.71 2.56-5.71 5.71m14.21-.57c-.53-.74-1.27-1.66-2.21-2.51.45.93.71 1.97.71 3.08 0 1.1-.26 2.14-.71 3.07.94-.85 1.68-1.77 2.21-2.51.24-.35.24-.78 0-1.13m-17.01 0c.53-.74 1.27-1.66 2.21-2.51-.45.93-.7 1.97-.7 3.08 0 1.1.25 2.14.7 3.07-.94-.85-1.68-1.77-2.21-2.51a.98.98 0 0 1 0-1.13M12 9.7c0-.39-.32-.71-.7-.62A3.002 3.002 0 0 0 12 15a3 3 0 0 0 2.91-2.31c.09-.38-.23-.69-.62-.69h-1c-.71 0-1.29-.59-1.29-1.3z"})))};function vx({icon:a,...r}){return $.jsx(a,{...r})}const Sf=V(vx)`
  & *[fill^='#'] {
    fill: var(--admiral-color-Neutral_Neutral50, ${a=>a.theme.color["Neutral/Neutral 50"]});
  }
  cursor: pointer;
...
`;function Cx(a){return a||{}}const Tg=m.forwardRef(({dimension:a="m",type:r,displayClearIcon:u,isLoading:c,status:s,handleInput:d=Cx,containerRef:v,icons:y,iconsBefore:h,iconsAfter:p,children:b,className:x,style:S,placeholder:w,skeleton:_=!1,showTooltip:B=!0,disableCopying:O,...A},z)=>{const L=m.useRef(null),J=v||m.useRef(null),Q=m.Children.toArray(p||y),te=m.Children.toArray(h),[ae,de]=m.useState(!1),[ne,he]=m.useState(!1),[Be,Ue]=m.useState(A.defaultValue??void 0),Me=A.value??Be;m.useEffect(()=>{vn(L.current)?de(!0):de(!1)},[ne,de]),m.useLayoutEffect(()=>{function ee(){document.activeElement!==L.current&&he(!0)}function K(){he(!1)}const E=J.current;if(E)return E.addEventListener("mouseenter",ee),E.addEventListener("mouseleave",K),E.addEventListener("mousedown",K),()=>{E.removeEventListener("mouseenter",ee),E.removeEventListener("mouseleave",K),E.removeEventListener("mousedown",K)}},[he]);const[pt,ze]=m.useState(!1);if(!A.readOnly&&r==="password"){const ee=pt?gx:px;Q.push($.jsx(Sf,{icon:ee,onClick:()=>{ze(!pt)},"aria-hidden":!0},"eye-icon"))}!A.readOnly&&u&&Me&&Q.unshift($.jsx(Sf,{icon:Uf,onMouseDown:ee=>{ee.preventDefault()},onClick:()=>{L.current&&ol(L.current,{value:""})},"aria-hidden":!0},"clear-icon")),c&&Q.unshift($.jsx(Gf,{dimension:a==="s"?"ms":"m"},"loading-icon"));const U=te.length,W=Q.length;return m.useLayoutEffect(()=>{const ee=d(null);function K(E){const{value:j,selectionStart:Z,selectionEnd:X}=this,I=d({value:j,selectionStart:Z,selectionEnd:X},E);w&&!vf(ee,I)?ol(this,{...I,value:""}):ol(this,I)}if(r!=="date"&&L.current){const E=L.current;E.addEventListener("input",K);const{value:j,selectionStart:Z,selectionEnd:X}=E,I=d({value:j,selectionStart:Z,selectionEnd:X});return w&&!vf(ee,I)?ol(E,{...I,value:""}):ol(E,I),()=>{E.removeEventListener("input",K)}}},[d,w]),m.useEffect(()=>{function ee(){this.selectionEnd=this.selectionStart}if(O&&L.current){const K=L.current;return K.addEventListener("select",ee,!0),()=>K.removeEventListener("select",ee,!0)}},[O]),$.jsxs($.Fragment,{children:[$.jsxs(Ox,{className:x,style:S,$dimension:a,ref:J,disabled:A.disabled,readOnly:A.readOnly,$isLoading:c,$status:s,"data-disabled":!!A.disabled||void 0,"data-read-only":!!A.readOnly||void 0,"data-loading":!!c||void 0,"data-status":s,$skeleton:_,"data-disable-copying":!!O||void 0,children:[$.jsx(Tx,{ref:ya(z,L),...A,onChange:ee=>{var K;Ue(ee.currentTarget.value),(K=A.onChange)==null||K.call(A,ee)},placeholder:w,$dimension:a,$iconsAfterCount:W,$iconsBeforeCount:U,type:r==="password"&&pt?"text":r}),$.jsx(rr,{$status:s,disabled:A.disabled||A.readOnly}),U>0&&$.jsx(Ax,{disabled:A.disabled,$dimension:a,children:te}),W>0&&$.jsx(Mx,{disabled:A.disabled,$dimension:a,children:Q}),b]}),B&&ne&&ae&&$.jsx(Hi,{renderContent:()=>{var ee;return((ee=L==null?void 0:L.current)==null?void 0:ee.value)||""},targetElement:J.current})]})});Tg.displayName="TextInput";const Dx=Y`
...
`,Rx=V.div`
  ...
  ${Bx};
  ${zx};
`,Ci=m.forwardRef(({dimension:a="m",appearance:r="default",orientation:u="horizontal",length:c="100%",...s},d)=>$.jsx(Rx,{...s,ref:d,$dimension:a,$appearance:r,$orientation:u,$length:c}));Ci.displayName="Divider";const Ag=m.createContext(null),Mg=()=>m.useContext(Ag),Hx=({children:a,...r})=>$.jsx(Ag.Provider,{value:r,children:a}),jx=m.createContext(null),Og=()=>m.useContext(jx),pr=35,yp=4,Vf=Y`
...
`,io=({value:a,disabled:r,renderChip:u,...c},s)=>{const d=u(),v={};return vr(c,v,"data",!1),(y=>typeof y=="object"&&y!==null&&!m.isValidElement(y))(d)?{...d,onClose:()=>{var y;return(y=d.onClose)==null?void 0:y.call(d,{value:a,disabled:r,...v})}}:{disabled:r,onClose:()=>s(a),children:d}},Sp=({className:a,option:r,disabled:u,readOnly:c,onClick:s,onChipRemove:d})=>{const v=m.useCallback(y=>()=>$.jsx(l2,{children:y}),[]);return $.jsx(r2,{className:a,tabIndex:-1,dimension:"s",appearance:"filled",onClick:s,onClose:c?void 0:io(r,d).onClose,disabled:io(r,d).disabled||u,renderContentTooltip:v(io(r,d).children),children:io(r,d).children})},i2=({count:a,disabled:r,onClick:u})=>{const c=m.useRef(null),s=m.useRef(null);return a?$.jsx(t2,{onClick:u,ref:c,className:"counter",children:$.jsxs(a2,{ref:s,"data-visible":!0,tabIndex:-1,dimension:"s",appearance:"filled",disabled:r,children:["+",a]})}):$.jsx(Dg,{})},u2=V.div`
  display: flex;
`,o2=m.forwardRef(({option:a,childrenOptions:r,containerRef:u,shouldShowCount:c,disabled:s,readOnly:d,onChipClick:v,onChipRemove:y},h)=>{const p=m.useRef(null),[b,x]=m.useState(!1);return m.useLayoutEffect(()=>{const S=new IntersectionObserver(function(w){if(w[0].isIntersecting&&!b){x(!0),w[0].target.setAttribute("data-visible","true");const _=w[0].target.previousElementSibling,B=w[0].target.nextElementSibling;return _&&_.removeAttribute("data-show-count"),void(B&&!B.getAttribute("data-visible")&&w[0].target.setAttribute("data-show-count",""))}if(b&&!w[0].isIntersecting){x(!1),w[0].target.removeAttribute("data-visible"),w[0].target.removeAttribute("data-show-count");const _=w[0].target.previousElementSibling;_&&_.getAttribute("data-visible")&&_.setAttribute("data-show-count","true")}},{root:u.current,threshold:[0,1]});return u.current&&p.current&&S.observe(p.current),()=>S.disconnect()},[b]),$.jsxs(u2,{ref:ya(h,p),onMouseDown:S=>S.preventDefault(),children:[$.jsx(Sp,{className:"chip",option:a,disabled:s,readOnly:d,onClick:v,onChipRemove:y}),c&&r.length>0&&$.jsx(i2,{count:r.length,disabled:s,children:r.map(S=>$.jsx(Sp,{option:S,disabled:s,readOnly:d,onClick:v,onChipRemove:y},S.value))}),!c&&$.jsx(Dg,{})]},a.value)}),c2=({options:a,isOptionsListOpen:r,containerRef:u,hasMaxHeight:c,...s})=>{const d=jf(r);return m.useEffect(()=>{var v,y,h;c&&a.length!==0&&(d&&!r&&((v=u.current)==null||v.scrollTo({top:0,left:0,behavior:"smooth"})),!d&&r&&setTimeout(()=>{var p,b,x;(p=u.current)==null||p.scrollTo({top:0,left:0,behavior:"instant"}),(x=u.current)==null||x.scrollTo({top:(b=u.current)==null?void 0:b.scrollHeight,left:0,behavior:"smooth"})}),r&&d&&((h=u.current)==null||h.scrollTo({top:(y=u.current)==null?void 0:y.scrollHeight,left:0,behavior:"smooth"})))},[r,a,c]),$.jsx($.Fragment,{children:a.map((v,y)=>$.jsx(o2,{option:v,childrenOptions:y<a.length-1?a.slice(y+1):[],containerRef:u,...s},v.value))})},ul=V.div`
  position: absolute;
  top: 0;
  bottom: 0;
  left: 0;
...
`,_2=({visibleValue:a,isSearchPanelOpen:r,targetRef:u,forceHideOverflowTooltip:c})=>{const s=m.useRef(null),[d,v]=m.useState(!1),[y,h]=m.useState(!1);m.useEffect(()=>{s.current&&vn(s.current)!==d&&v(vn(s.current))},[y,v]),m.useEffect(()=>{function b(){h(!0)}function x(){h(!1)}const S=s.current;if(S)return S.addEventListener("mouseenter",b),S.addEventListener("mouseleave",x),()=>{S.removeEventListener("mouseenter",b),S.removeEventListener("mouseleave",x)}},[h]);const p=!c&&!r&&y&&d;return $.jsxs($.Fragment,{children:[$.jsx(d2,{ref:s,children:a}),p&&$.jsx(Hi,{renderContent:()=>a,targetElement:u.current})]})},N2=a=>a.stopPropagation(),w2=V.select`
  position: absolute;
  left: 0;
  top: 0;
  width: 100%;
  ...
  border: none;
  pointer-events: none;
`,T2=m.forwardRef(({options:a,...r},u)=>{const c=m.useRef(null);return m.useEffect(()=>{var d;function s(v){const y=G.getCode(v);y&&[G[" "],G.Enter,G.ArrowDown,G.ArrowUp].includes(y)&&v.preventDefault()}return(d=c.current)==null||d.addEventListener("keydown",s),()=>{var v;return(v=c.current)==null?void 0:v.removeEventListener("keydown",s)}},[]),$.jsxs(w2,{ref:ya(u,c),...r,onClick:N2,children:[$.jsx("option",{value:""}),a.map(s=>$.jsx("option",{value:s.value,disabled:s.disabled,children:s.value},s.value))]})}),Rg=m.createContext(null),A2=()=>m.useContext(Rg),M2=({children:a,...r})=>$.jsx(Rg.Provider,{value:r,children:a}),O2=(a="",r="",u="wholly")=>{const c=(u==="word"?r.split(" "):[r]).filter(Boolean).map(y=>y.toLowerCase()),s=["[","]","\\","^","$",".","|","?","*","+","(",")"],d=c.map(y=>`(${y.split("").map(h=>s.includes(h)?`\\${h}`:h).join("")})?`).join(""),v=a.split(new RegExp(d,"gi")).filter(Boolean);return!r||v.some(y=>c.includes(y.toLowerCase()))},C2=V.label`
  display: inline-flex;
...
`,z2=V(_g)`
  margin-top: 2px;
`,Hg=m.forwardRef(({children:a,disabled:r=!1,readOnly:u=!1,hovered:c,dimension:s="m",error:d,indeterminate:v=!1,extraText:y,className:h,id:p,name:b,style:x,...S},w)=>{const _=m.useMemo(()=>p||ji(),[p]),B={"data-field-id":_,"data-field-name":b};return Bf(S,B),$.jsxs(C2,{className:h,$dimension:s,disabled:r,readOnly:u,style:x,...B,onClick:O=>{O.target.tagName!=="INPUT"&&O.stopPropagation()},children:[$.jsx(z2,{...S,ref:w,disabled:r,readOnly:u,type:"checkbox",indeterminate:v,onKeyDown:O=>{var A;u&&G.getCode(O)===G[" "]&&O.preventDefault(),(A=S.onKeyDown)==null||A.call(S,O)},"data-hovered":c,hovered:c,dimension:s,id:_,name:b,error:d}),a&&$.jsxs(D2,{$dimension:s,disabled:r,children:[a,y&&$.jsx(B2,{disabled:r,$dimension:s,children:y})]})]})});Hg.displayName="CheckboxField";V(zg)`
...
`;const R2=V(Hg)`
  margin-right: 8px;
  flex-shrink: 0;
`,H2=a=>Mg()?$.jsx(j2,{...a}):null,j2=({disabled:a=!1,id:r,value:u,children:c,renderOption:s,renderChip:d,...v})=>{const y=Mg(),h=Og(),p=(h==null?void 0:h.disabled)||a,b=m.useCallback(()=>c,[c]),x=d||b,S=m.useMemo(()=>s?s({disabled:a}):c,[s,a,u,c]),w={};vr(v,w,"data",!1);const _=m.useMemo(()=>({id:r,value:u,disabled:p,children:S,renderChip:x,...w}),[r,u,p,S,x]);return m.useEffect(()=>{var B;return(B=y==null?void 0:y.onConstantOptionMount)==null||B.call(y,_),()=>{var O;return(O=y==null?void 0:y.onConstantOptionUnMount)==null?void 0:O.call(y,_)}},[y==null?void 0:y.onConstantOptionMount,y==null?void 0:y.onConstantOptionUnMount,_]),null},L2=({id:a,disabled:r=!1,readOnly:u=!1,value:c,children:s,renderOption:d,renderChip:v,...y})=>{const h=A2(),p=Og(),b=(p==null?void 0:p.disabled)||r,x=S=>h!=null&&h.multiple?(({selected:w=!1,hovered:_=!1})=>$.jsxs($.Fragment,{children:[(h==null?void 0:h.showCheckbox)&&$.jsx(R2,{checked:w,hovered:_,dimension:(h==null?void 0:h.dimension)==="s"?"s":"m",disabled:r,onChange:()=>!1}),s]}))(S):s;return m.useEffect(()=>{var _;const S=a||c,w={id:c,value:c,render:B=>{return d?d(B):m.createElement($2,{...B,dimension:(O=h==null?void 0:h.dimension,O==="xl"?"l":O),key:S,...y,$selected:B.selected,$hovered:B.hovered,$preselected:B.preselected,$multiple:h==null?void 0:h.multiple},x({selected:B.selected,hovered:B.hovered}));var O},disabled:b,readOnly:u};return(_=h==null?void 0:h.onDropDownOptionMount)==null||_.call(h,w),()=>{var B;return(B=h==null?void 0:h.onDropDownOptionUnMount)==null?void 0:B.call(h,w)}},[h==null?void 0:h.onDropDownOptionMount,h==null?void 0:h.onDropDownOptionUnMount,h==null?void 0:h.dimension,h==null?void 0:h.multiple]),null},sn=a=>$.jsxs($.Fragment,{children:[$.jsx(H2,{...a}),$.jsx(L2,{...a})]}),U2=()=>m.useMemo(ji,[]),k2=V(zg)`
  color: var(--admiral-color-Neutral_Neutral50, ${a=>a.theme.color["Neutral/Neutral 50"]});
`,xp=a=>a.stopPropagation(),Ep=()=>{},jg=m.forwardRef(({value:a,isLoading:r,className:u,style:c,status:s,icons:d,portalTargetRef:v,targetElement:y,inputTargetRef:h,disabled:p,readOnly:b,placeholder:x,defaultValue:S,dimension:w="m",idleHeight:_="fixed",minRowCount:B="none",maxRowCount:O="none",mode:A="select",multiple:z=!1,showCheckbox:L=!0,displayClearIcon:J=!1,onClearIconClick:Q,onInputChange:te,inputValue:ae,defaultInputValue:de,renderSelectValue:ne,onFocus:he,onBlur:Be,children:Ue,alignDropdown:Me="stretch",alignSelf:pt="stretch",skeleton:ze=!1,locale:U,dropContainerCssMixin:W,dropContainerClassName:ee,dropContainerStyle:K,renderDropDownTopPanel:E,renderDropDownBottomPanel:j,renderTopPanel:Z,renderBottomPanel:X,forcedOpen:I=!1,onChangeDropDownState:fe,onInputKeyDown:ue,onInputKeyUp:Xe,onInputKeyUpCapture:ye,onInputKeyDownCapture:et,searchFormat:Ot="wholly",onFilterItem:Qe=O2,virtualScroll:Re,title:Ht,forceHideOverflowTooltip:Ca=!1,onSelectedChange:ba,moveSelectedOnTop:_t,clearInputValueAfterSelect:Ke=!0,openButtonPropsConfig:kt=Ep,clearButtonPropsConfig:jt=Ep,...tt},nt)=>{const Sa=rg()||Df,bn=(U==null?void 0:U.emptyMessage)||$.jsx(k2,{$dimension:w,children:Sa.locales[Sa.currentLocale].select.emptyMessage}),[ke,Yl]=m.useState(a??S),[Da,bt]=m.useState(""),Je=ae===void 0?Da:ae,[st,re]=m.useState(!1),[ce,ve]=m.useState(),[Oe,Ze]=m.useState([]),[He,Vt]=m.useState([]),[we,Xt]=m.useState(I),[Qt,la]=m.useState(!1),[na,Zt]=m.useState(void 0),fl=a===void 0,ra=A==="select",Pi=m.useMemo(()=>O!=="none"&&O>0?O:_==="fixed"?1:"none",[O,_])!=="none",Sn=a??S,Ba=m.useRef(Array.isArray(Sn)?Sn:[]),Pl=m.useRef(!1),xa=m.useRef([]);m.useEffect(()=>{Array.isArray(a)&&(Ba.current=a)},[a]);const ia=m.useMemo(()=>z?null:Oe.find(F=>F.value===ke),[z,Oe,ke]),at=m.useMemo(()=>z&&Array.isArray(ke)?ke.reduce((F,se)=>{const ie=Oe.find(Ge=>Ge.value===se);return ie&&F.push(ie),F},[]):[],[Oe,ke,z]),Ct=jf(we),[Ea,xn]=m.useState([]);m.useEffect(()=>{if(z&&_t||!(Ea.length>0)||xn([]),z&&_t&&Ct!==we&&we){const F=at.map(ie=>ie.value),se=F.length>0?F.reduce((ie,Ge)=>{const ut=He.find(pl=>pl.value===Ge);return ut&&ie.push(ut),ie},[]):[];xn(se)}},[He,we,at,z,_t]);const Sr=m.useMemo(()=>{const F=Ea.map(ie=>ie.value),se=He.filter(ie=>Qe(ie.value,Je,Ot)).reduce((ie,Ge)=>(F.includes(Ge.value)||ie.push(Ge),ie),[...Ea]);return se.length?se:[{id:"emptyMessage",render:()=>$.jsx(E2,{children:bn},"empty"),disabled:!0}]},[r,He,w,Je,Ea]);m.useEffect(()=>{ce&&(Sr.find(F=>F.id===ce)||ve(void 0))},[Sr,ce]);const ua=h??m.useRef(null),Pa=m.useRef(null),Dt=m.useRef(null),xr=y||(v==null?void 0:v.current)||Dt.current,Ga=m.useRef(null),oa=m.useRef(null),Va=m.useRef({shouldExtendInputValue:!1}),dl=F=>{Ze(se=>[...se,F]),xa.current.includes(F.value)&&(xa.current=xa.current.filter(se=>se!==F.value))},ft=F=>{Ba.current.includes(F.value)&&(xa.current=[...xa.current,F.value]),Ze(se=>se.filter(ie=>ie.value!==F.value))},Gi=m.useCallback(F=>{Vt(se=>[...se,F])},[]),Vi=m.useCallback(F=>{Vt(se=>se.filter(ie=>ie.id!==F.id))},[]),$a=m.useCallback(()=>{Xt(!1),ua.current&&ol(ua.current,{value:""}),re(!0)},[ke]),ca=m.useCallback(F=>{const se=Pa.current;if(!se)return;const ie=Array.from(se.options),Ge=ie.find(ut=>ut.value===F);if(Ge&&(z||ie.forEach(ut=>ut.selected=!1),Ge.selected=!z||!Ge.selected,se.dispatchEvent(new Event("change",{bubbles:!0})),z||$a(),Je&&ua.current&&Ke)){ol(ua.current,{value:"",selectionEnd:0,selectionStart:0});const ut=ce;ve(""),setTimeout(()=>ve(ut))}},[$a,z,Je,ce]),zo=m.useCallback(()=>{const F=Pa.current;F&&(F.selectedIndex=-1,F.dispatchEvent(new Event("change",{bubbles:!0})))},[]);m.useEffect(()=>{I!==we&&Xt(I)},[I]),m.useEffect(()=>{var F;fe==null||fe(we),!we&&Qt&&document.activeElement!==Dt.current&&((F=Pa.current)==null||F.focus())},[we,Qt]);const Xi=Q||zo,Er=Pi&&!we,Ro=m.useCallback(()=>$.jsx(c2,{containerRef:Ga,options:at,shouldShowCount:Er,disabled:p,readOnly:b,onChipRemove:ca,onChipClick:xp,isOptionsListOpen:we,hasMaxHeight:!!O&&O!=="none"}),[at,Er,p,b,ca,we,O]),hl=(z?!(ke!=null&&ke.length):!ke)&&!!x&&!Je,En=ne==null?void 0:ne(ke,Je),_a=ia==null?void 0:ia.children,$r=z?Ro():_a,ml=En||$r||ke||null,Na=typeof ml=="string",_r=Na?$.jsx(_2,{visibleValue:ml,isSearchPanelOpen:we,targetRef:Dt,forceHideOverflowTooltip:Ca}):ml,$n=()=>{Xt(F=>!F)},Ho=()=>{if(!Je&&ke)return z?void(()=>{var ie;const F=(se=[...at].reverse(),(ie=se.find(({disabled:Ge})=>!Ge))==null?void 0:ie.value);var se;F&&ca(F)})():re(!1)};m.useEffect(()=>{var se;if(!b&&!p)return(se=Dt.current)==null||se.addEventListener("keydown",F),()=>{var ie;(ie=Dt.current)==null||ie.removeEventListener("keydown",F)};function F(ie){const Ge=G.getCode(ie);Ge===G[" "]&&(!ra&&Je?ie.stopPropagation():we||(ie.preventDefault(),Xt(!0),ie.stopPropagation())),Ge!==G.Enter||we||(ie.preventDefault(),Xt(!0),ie.stopPropagation()),Ge!==G.ArrowDown&&Ge!==G.ArrowUp||we||(Xt(!0),ie.stopPropagation());const ut=ie.ctrlKey||ie.metaKey||ie.altKey;ie.key.length!==1||ut||Na&&!Je&&st&&(Va.current.shouldExtendInputValue=!0),Ge!==G.Backspace||ie.repeat||Ho(),Ge===G.Backspace&&((pl=>{if(!Na||!ua.current||Je||!st||!ke)return;pl.preventDefault();const za=ml.slice(0,-1);ol(ua.current,{value:za,selectionEnd:za.length,selectionStart:za.length})})(ie),Xt(!0)),Ge===G.Escape&&we&&(Xt(!1),ie.preventDefault(),ie.stopPropagation())}},[b,p,ra,Je,we,at]),m.useEffect(()=>{var se;function F(){Pl.current=!1}return(se=Dt.current)==null||se.addEventListener("keyup",F),()=>{var ie;(ie=Dt.current)==null||ie.removeEventListener("keyup",F)}},[]),m.useEffect(()=>{(!Qt&&!z||z)&&(ua.current&&ol(ua.current,{value:""}),re(!0))},[z,Qt]),m.useEffect(()=>{var F,se;we&&(ra?(F=Pa.current)==null||F.focus():(se=ua.current)==null||se.focus(),Zt(""))},[we,ra]),m.useEffect(()=>{na&&ve("")},[na]),m.useEffect(()=>{ce&&Zt("")},[ce]),m.useEffect(()=>{if(we){const F=ke&&!Array.isArray(ke)?ke:void 0;ve(F)}},[we]),m.useEffect(()=>{fl||Yl(a)},[a,fl]),dg([Dt,oa],F=>{var se;F.target&&((se=Dt.current)!=null&&se.contains(F.target))||(la(!1),$a())});const Qi=st&&(z?!!(ke!=null&&ke.length):!!ke),Nt=m.useMemo(()=>m.Children.map(Ue,F=>m.isValidElement(F)?m.cloneElement(F,{key:ji(),...F.props}):null),[Ue]),Zi=m.useMemo(()=>$.jsx(M2,{onDropDownOptionMount:Gi,onDropDownOptionUnMount:Vi,dimension:w,multiple:z,showCheckbox:L,children:Nt}),[Nt,w,L,z]),jo=m.useMemo(()=>$.jsx(Hx,{onConstantOptionMount:dl,onConstantOptionUnMount:ft,children:Nt}),[Nt]),_n=Sb(tt),Fi=cg(tt),Gl={icon:Uf,id:"searchSelectClearIcon",onClick:Xi,"aria-hidden":!0},Ki={$isOpen:we,onClick:$n,"aria-hidden":!0};return $.jsxs(b2,{className:u,style:c,$focused:Qt,$multiple:z,disabled:p,"data-disabled":p,$readonly:b,$isLoading:r,$dimension:w,ref:Dt,"data-status":s,onClick:p||b||r?void 0:F=>{var se;F.target&&((se=oa.current)!=null&&se.contains(F.target))||!ra&&we||$n()},onFocus:F=>{Qt||(la(!0),he==null||he(F))},onMouseDown:F=>{Qt&&F.preventDefault()},$skeleton:ze,onBlur:F=>{var se,ie;F.currentTarget.contains(F.relatedTarget)||(se=oa.current)!=null&&se.contains(F.relatedTarget)||(la(!1),Xt(!1),(ie=Pa.current)==null||ie.blur(),Be==null||Be(F),Pl.current=!1)},title:Ht,children:[jo,Zi,$.jsx(T2,{ref:ya(nt,Pa),value:ke,multiple:z,disabled:p,options:Oe,...tt,onChange:F=>{var Ge;if(Pl.current&&ra)return void Zt(F.target.value);const se=z?Array.from(F.target.selectedOptions).map(ut=>ut.value):F.target.value;let ie=[];if(z&&Array.isArray(se)){const ut=se.filter(Lt=>!Ba.current.includes(Lt)&&!xa.current.includes(Lt)),pl=Ba.current.filter(Lt=>!se.includes(Lt)&&!xa.current.includes(Lt));ie=[...Ba.current,...ut];const za=[...xa.current];pl.forEach(Lt=>{const Wi=ie.findIndex(Nn=>Lt===Nn);Wi>-1&&ie.splice(Wi,1);const Nr=za.findIndex(Nn=>Lt===Nn);Nr>-1&&za.splice(Nr,1)}),Ba.current=ie,xa.current=za}fl&&Yl(z?ie:se),(Ge=tt.onChange)==null||Ge.call(tt,F),ba==null||ba(z?ie:se)}}),$.jsx(ul,{}),$.jsxs(Bg,{tabIndex:-1,ref:Ga,className:"selectValueWrapper",$dimension:w,$multiple:z,$minRowCount:B!=="none"?B:void 0,$maxRowCount:O!=="none"?O:void 0,$idleHeight:_,$opened:we,$isEmpty:hl,children:[st&&_r,(x&&hl||!ra)&&$.jsx(m2,{"data-id":tt.id,placeholder:hl?x:"",tabIndex:-1,ref:ua,disabled:p,readOnly:b||ra,value:Je,defaultValue:de,$isMultiple:z,$dimension:w,onChange:F=>{z||re(!1),(se=>{Va.current.shouldExtendInputValue&&Na&&(se.target.value=`${ml}${se.target.value}`,Va.current.shouldExtendInputValue=!1)})(F),ae===void 0&&bt(F.target.value),te==null||te(F)},onKeyDown:ue,onKeyUp:Xe,onKeyUpCapture:ye,onKeyDownCapture:et})]}),we&&!ze&&$.jsx(Rf,{ref:oa,tabIndex:-1,targetElement:xr,"data-dimension":w,alignSelf:Me||pt,dropContainerCssMixin:W,className:ee,style:K,..._n,children:$.jsx(x2,{dimension:w==="xl"?"l":w,active:ce,selected:ke,onActivateItem:F=>ve(F),onSelectItem:ca,onDeselectItem:ca,multiSelection:z,model:Sr,renderTopPanel:E||Z,renderBottomPanel:j||X,containerRef:oa,virtualScroll:Re,preventFocusSteal:!0,preselectedModeActive:ra,preselected:na,onPreselectItem:Zt,onMenuKeyDown:()=>{Pl.current=!0},...Fi})}),$.jsxs(y2,{$multiple:z,$dimension:w,onClick:xp,onMouseDown:F=>F.preventDefault(),children:[r&&$.jsx(Gf,{dimension:w==="s"?"ms":"m"}),J&&!b&&Qi&&$.jsx(Sf,{...Gl,...jt(Gl)}),d,!b&&$.jsx(xb,{"data-disabled":!!p||void 0,"data-loading":!!r||void 0,...Ki,...kt(Ki)})]})]})});jg.displayName="Select";const xo=m.forwardRef((a,r)=>{const u=m.useRef(null),{className:c,maxLength:s,displayInline:d,status:v,required:y,extraText:h,label:p,id:b=ji(),disabled:x,displayCharacterCounter:S,characterCounterVisibilityThreshold:w,skeleton:_,...B}=a,O={className:c,extraText:h,status:v,required:y,label:p,id:b,displayInline:d,disabled:x,maxLength:s,inputRef:u,displayCharacterCounter:S,characterCounterVisibilityThreshold:w,skeleton:_,"data-field-id":b,"data-field-name":B.name};og(B,O),Bf(B,O);const A={ref:ya(r,u),id:b,"aria-required":y,status:v,disabled:x,maxLength:s,skeleton:_,...B};return $.jsx(Pf,{...O,children:$.jsx(Tg,{...A})})});xo.displayName="InputField";const q2=V(jg)`
  [data-status='error'] & {
    border-color: var(--admiral-color-Error_Error60Main, ${a=>a.theme.color["Error/Error 60 Main"]});
  }
`,ir=m.forwardRef((a,r)=>{const{className:u,displayInline:c,status:s,required:d,extraText:v,label:y,id:h=U2(),disabled:p,skeleton:b,...x}=a,S={className:u,extraText:v,status:s,required:d,label:y,id:h,displayInline:c,disabled:p,skeleton:b,"data-field-id":h,"data-field-name":x.name};og(x,S),Bf(x,S);const w={ref:r,id:h,"aria-required":d,status:s,disabled:p,skeleton:b,...x};return $.jsx(Pf,{...S,children:$.jsx(q2,{...w})})});ir.displayName="SelectField";const Y2=Y`
...
`;function tE(a){return $.jsx("style",{type:"text/css",children:eE,...a})}var Si={},$p;function aE(){if($p)return Si;$p=1,Object.defineProperty(Si,"__esModule",{value:!0}),Si.parse=v,Si.serialize=p;const a=/^[\u0021-\u003A\u003C\u003E-\u007E]+$/,r=/^[\u0021-\u003A\u003C-\u007E]*$/,u=/^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i,c=/^[\u0020-\u003A\u003D-\u007E]*$/,s=Object.prototype.toString,d=(()=>{const S=function(){};return S.prototype=Object.create(null),S})();function v(S,w){const _=new d,B=S.length;if(B<2)return _;const O=(w==null?void 0:w.decode)||b;let A=0;do{const z=S.indexOf("=",A);if(z===-1)break;const L=S.indexOf(";",A),J=L===-1?B:L;if(z>J){A=S.lastIndexOf(";",z-1)+1;continue}const Q=y(S,A,z),te=h(S,z,Q),ae=S.slice(Q,te);if(_[ae]===void 0){let de=y(S,z+1,J),ne=h(S,J,de);const he=O(S.slice(de,ne));_[ae]=he}A=J+1}while(A<B);return _}function y(S,w,_){do{const B=S.charCodeAt(w);if(B!==32&&B!==9)return w}while(++w<_);return _}function h(S,w,_){for(;w>_;){const B=S.charCodeAt(--w);if(B!==32&&B!==9)return w+1}return _}function p(S,w,_){const B=(_==null?void 0:_.encode)||encodeURIComponent;if(!a.test(S))throw new TypeError(`argument name is invalid: ${S}`);const O=B(w);if(!r.test(O))throw new TypeError(`argument val is invalid: ${w}`);let A=S+"="+O;if(!_)return A;if(_.maxAge!==void 0){if(!Number.isInteger(_.maxAge))throw new TypeError(`option maxAge is invalid: ${_.maxAge}`);A+="; Max-Age="+_.maxAge}if(_.domain){if(!u.test(_.domain))throw new TypeError(`option domain is invalid: ${_.domain}`);A+="; Domain="+_.domain}if(_.path){if(!c.test(_.path))throw new TypeError(`option path is invalid: ${_.path}`);A+="; Path="+_.path}if(_.expires){if(!x(_.expires)||!Number.isFinite(_.expires.valueOf()))throw new TypeError(`option expires is invalid: ${_.expires}`);A+="; Expires="+_.expires.toUTCString()}if(_.httpOnly&&(A+="; HttpOnly"),_.secure&&(A+="; Secure"),_.partitioned&&(A+="; Partitioned"),_.priority)switch(typeof _.priority=="string"?_.priority.toLowerCase():void 0){case"low":A+="; Priority=Low";break;case"medium":A+="; Priority=Medium";break;case"high":A+="; Priority=High";break;default:throw new TypeError(`option priority is invalid: ${_.priority}`)}if(_.sameSite)switch(typeof _.sameSite=="string"?_.sameSite.toLowerCase():_.sameSite){case!0:case"strict":A+="; SameSite=Strict";break;case"lax":A+="; SameSite=Lax";break;case"none":A+="; SameSite=None";break;default:throw new TypeError(`option sameSite is invalid: ${_.sameSite}`)}return A}function b(S){if(S.indexOf("%")===-1)return S;try{return decodeURIComponent(S)}catch{return S}}function x(S){return s.call(S)==="[object Date]"}return Si}aE();var _p="popstate";function lE(a={}){function r(c,s){let{pathname:d,search:v,hash:y}=c.location;return _f("",{pathname:d,search:v,hash:y},s.state&&s.state.usr||null,s.state&&s.state.key||"default")}function u(c,s){return typeof s=="string"?s:Di(s)}return rE(r,u,null,a)}function yt(a,r){if(a===!1||a===null||typeof a>"u")throw new Error(r)}function Oa(a,r){if(!a){typeof console<"u"&&console.warn(r);try{throw new Error(r)}catch{}}}function nE(){return Math.random().toString(36).substring(2,10)}function Np(a,r){return{usr:a.state,key:a.key,idx:r}}function _f(a,r,u=null,c){return{pathname:typeof a=="string"?a:a.pathname,search:"",hash:"",...typeof r=="string"?Li(r):r,state:u,key:r&&r.key||c||nE()}}function Di({pathname:a="/",search:r="",hash:u=""}){return r&&r!=="?"&&(a+=r.charAt(0)==="?"?r:"?"+r),u&&u!=="#"&&(a+=u.charAt(0)==="#"?u:"#"+u),a}function Li(a){let r={};if(a){let u=a.indexOf("#");u>=0&&(r.hash=a.substring(u),a=a.substring(0,u));let c=a.indexOf("?");c>=0&&(r.search=a.substring(c),a=a.substring(0,c)),a&&(r.pathname=a)}return r}function rE(a,r,u,c={}){let{window:s=document.defaultView,v5Compat:d=!1}=c,v=s.history,y="POP",h=null,p=b();p==null&&(p=0,v.replaceState({...v.state,idx:p},""));function b(){return(v.state||{idx:null}).idx}function x(){y="POP";let O=b(),A=O==null?null:O-p;p=O,h&&h({action:y,location:B.location,delta:A})}function S(O,A){y="PUSH";let z=_f(B.location,O,A);p=b()+1;let L=Np(z,p),J=B.createHref(z);try{v.pushState(L,"",J)}catch(Q){if(Q instanceof DOMException&&Q.name==="DataCloneError")throw Q;s.location.assign(J)}d&&h&&h({action:y,location:B.location,delta:1})}function w(O,A){y="REPLACE";let z=_f(B.location,O,A);p=b();let L=Np(z,p),J=B.createHref(z);v.replaceState(L,"",J),d&&h&&h({action:y,location:B.location,delta:0})}function _(O){return iE(O)}let B={get action(){return y},get location(){return a(s,v)},listen(O){if(h)throw new Error("A history only accepts one active listener");return s.addEventListener(_p,x),h=O,()=>{s.removeEventListener(_p,x),h=null}},createHref(O){return r(s,O)},createURL:_,encodeLocation(O){let A=_(O);return{pathname:A.pathname,search:A.search,hash:A.hash}},push:S,replace:w,go(O){return v.go(O)}};return B}function iE(a,r=!1){let u="http://localhost";typeof window<"u"&&(u=window.location.origin!=="null"?window.location.origin:window.location.href),yt(u,"No window.location.(origin|href) available to create URL");let c=typeof a=="string"?a:Di(a);return c=c.replace(/ $/,"%20"),!r&&c.startsWith("//")&&(c=u+c),new URL(c,u)}function Lg(a,r,u="/"){return uE(a,r,u,!1)}function uE(a,r,u,c){let s=typeof r=="string"?Li(r):r,d=sl(s.pathname||"/",u);if(d==null)return null;let v=Ug(a);oE(v);let y=null;for(let h=0;y==null&&h<v.length;++h){let p=bE(d);y=vE(v[h],p,c)}return y}function Ug(a,r=[],u=[],c=""){let s=(d,v,y)=>{let h={relativePath:y===void 0?d.path||"":y,caseSensitive:d.caseSensitive===!0,childrenIndex:v,route:d};h.relativePath.startsWith("/")&&(yt(h.relativePath.startsWith(c),`Absolute route path "${h.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),h.relativePath=h.relativePath.slice(c.length));let p=cl([c,h.relativePath]),b=u.concat(h);d.children&&d.children.length>0&&(yt(d.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${p}".`),Ug(d.children,r,b,p)),!(d.path==null&&!d.index)&&r.push({path:p,score:pE(p,d.index),routesMeta:b})};return a.forEach((d,v)=>{var y;if(d.path===""||!((y=d.path)!=null&&y.includes("?")))s(d,v);else for(let h of kg(d.path))s(d,v,h)}),r}function kg(a){let r=a.split("/");if(r.length===0)return[];let[u,...c]=r,s=u.endsWith("?"),d=u.replace(/\?$/,"");if(c.length===0)return s?[d,""]:[d];let v=kg(c.join("/")),y=[];return y.push(...v.map(h=>h===""?d:[d,h].join("/"))),s&&y.push(...v),y.map(h=>a.startsWith("/")&&h===""?"/":h)}function oE(a){a.sort((r,u)=>r.score!==u.score?u.score-r.score:gE(r.routesMeta.map(c=>c.childrenIndex),u.routesMeta.map(c=>c.childrenIndex)))}var cE=/^:[\w-]+$/,sE=3,fE=2,dE=1,hE=10,mE=-2,wp=a=>a==="*";function pE(a,r){let u=a.split("/"),c=u.length;return u.some(wp)&&(c+=mE),r&&(c+=fE),u.filter(s=>!wp(s)).reduce((s,d)=>s+(cE.test(d)?sE:d===""?dE:hE),c)}function gE(a,r){return a.length===r.length&&a.slice(0,-1).every((c,s)=>c===r[s])?a[a.length-1]-r[r.length-1]:0}function vE(a,r,u=!1){let{routesMeta:c}=a,s={},d="/",v=[];for(let y=0;y<c.length;++y){let h=c[y],p=y===c.length-1,b=d==="/"?r:r.slice(d.length)||"/",x=Eo({path:h.relativePath,caseSensitive:h.caseSensitive,end:p},b),S=h.route;if(!x&&p&&u&&!c[c.length-1].route.index&&(x=Eo({path:h.relativePath,caseSensitive:h.caseSensitive,end:!1},b)),!x)return null;Object.assign(s,x.params),v.push({params:s,pathname:cl([d,x.pathname]),pathnameBase:$E(cl([d,x.pathnameBase])),route:S}),x.pathnameBase!=="/"&&(d=cl([d,x.pathnameBase]))}return v}function Eo(a,r){typeof a=="string"&&(a={path:a,caseSensitive:!1,end:!0});let[u,c]=yE(a.path,a.caseSensitive,a.end),s=r.match(u);if(!s)return null;let d=s[0],v=d.replace(/(.)\/+$/,"$1"),y=s.slice(1);return{params:c.reduce((p,{paramName:b,isOptional:x},S)=>{if(b==="*"){let _=y[S]||"";v=d.slice(0,d.length-_.length).replace(/(.)\/+$/,"$1")}const w=y[S];return x&&!w?p[b]=void 0:p[b]=(w||"").replace(/%2F/g,"/"),p},{}),pathname:d,pathnameBase:v,pattern:a}}function yE(a,r=!1,u=!0){Oa(a==="*"||!a.endsWith("*")||a.endsWith("/*"),`Route path "${a}" will be treated as if it were "${a.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${a.replace(/\*$/,"/*")}".`);let c=[],s="^"+a.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(v,y,h)=>(c.push({paramName:y,isOptional:h!=null}),h?"/?([^\\/]+)?":"/([^\\/]+)"));return a.endsWith("*")?(c.push({paramName:"*"}),s+=a==="*"||a==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):u?s+="\\/*$":a!==""&&a!=="/"&&(s+="(?:(?=\\/|$))"),[new RegExp(s,r?void 0:"i"),c]}function bE(a){try{return a.split("/").map(r=>decodeURIComponent(r).replace(/\//g,"%2F")).join("/")}catch(r){return Oa(!1,`The URL path "${a}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${r}).`),a}}function sl(a,r){if(r==="/")return a;if(!a.toLowerCase().startsWith(r.toLowerCase()))return null;let u=r.endsWith("/")?r.length-1:r.length,c=a.charAt(u);return c&&c!=="/"?null:a.slice(u)||"/"}function SE(a,r="/"){let{pathname:u,search:c="",hash:s=""}=typeof a=="string"?Li(a):a;return{pathname:u?u.startsWith("/")?u:xE(u,r):r,search:_E(c),hash:NE(s)}}function xE(a,r){let u=r.replace(/\/+$/,"").split("/");return a.split("/").forEach(s=>{s===".."?u.length>1&&u.pop():s!=="."&&u.push(s)}),u.length>1?u.join("/"):"/"}function Fs(a,r,u,c){return`Cannot include a '${a}' character in a manually specified \`to.${r}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${u}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function EE(a){return a.filter((r,u)=>u===0||r.route.path&&r.route.path.length>0)}function qg(a){let r=EE(a);return r.map((u,c)=>c===r.length-1?u.pathname:u.pathnameBase)}function Yg(a,r,u,c=!1){let s;typeof a=="string"?s=Li(a):(s={...a},yt(!s.pathname||!s.pathname.includes("?"),Fs("?","pathname","search",s)),yt(!s.pathname||!s.pathname.includes("#"),Fs("#","pathname","hash",s)),yt(!s.search||!s.search.includes("#"),Fs("#","search","hash",s)));let d=a===""||s.pathname==="",v=d?"/":s.pathname,y;if(v==null)y=u;else{let x=r.length-1;if(!c&&v.startsWith("..")){let S=v.split("/");for(;S[0]==="..";)S.shift(),x-=1;s.pathname=S.join("/")}y=x>=0?r[x]:"/"}let h=SE(s,y),p=v&&v!=="/"&&v.endsWith("/"),b=(d||v===".")&&u.endsWith("/");return!h.pathname.endsWith("/")&&(p||b)&&(h.pathname+="/"),h}var cl=a=>a.join("/").replace(/\/\/+/g,"/"),$E=a=>a.replace(/\/+$/,"").replace(/^\/*/,"/"),_E=a=>!a||a==="?"?"":a.startsWith("?")?a:"?"+a,NE=a=>!a||a==="#"?"":a.startsWith("#")?a:"#"+a;function wE(a){return a!=null&&typeof a.status=="number"&&typeof a.statusText=="string"&&typeof a.internal=="boolean"&&"data"in a}var Pg=["POST","PUT","PATCH","DELETE"];new Set(Pg);var TE=["GET",...Pg];new Set(TE);var yr=m.createContext(null);yr.displayName="DataRouter";var Co=m.createContext(null);Co.displayName="DataRouterState";var Gg=m.createContext({isTransitioning:!1});Gg.displayName="ViewTransition";var AE=m.createContext(new Map);AE.displayName="Fetchers";var ME=m.createContext(null);ME.displayName="Await";var qa=m.createContext(null);qa.displayName="Navigation";var Do=m.createContext(null);Do.displayName="Location";var Ya=m.createContext({outlet:null,matches:[],isDataRoute:!1});Ya.displayName="Route";var Qf=m.createContext(null);Qf.displayName="RouteError";function OE(a,{relative:r}={}){yt(Ui(),"useHref() may be used only in the context of a <Router> component.");let{basename:u,navigator:c}=m.useContext(qa),{hash:s,pathname:d,search:v}=ki(a,{relative:r}),y=d;return u!=="/"&&(y=d==="/"?u:cl([u,d])),c.createHref({pathname:y,search:v,hash:s})}function Ui(){return m.useContext(Do)!=null}function ql(){return yt(Ui(),"useLocation() may be used only in the context of a <Router> component."),m.useContext(Do).location}var Vg="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function Xg(a){m.useContext(qa).static||m.useLayoutEffect(a)}function br(){let{isDataRoute:a}=m.useContext(Ya);return a?GE():CE()}function CE(){yt(Ui(),"useNavigate() may be used only in the context of a <Router> component.");let a=m.useContext(yr),{basename:r,navigator:u}=m.useContext(qa),{matches:c}=m.useContext(Ya),{pathname:s}=ql(),d=JSON.stringify(qg(c)),v=m.useRef(!1);return Xg(()=>{v.current=!0}),m.useCallback((h,p={})=>{if(Oa(v.current,Vg),!v.current)return;if(typeof h=="number"){u.go(h);return}let b=Yg(h,JSON.parse(d),s,p.relative==="path");a==null&&r!=="/"&&(b.pathname=b.pathname==="/"?r:cl([r,b.pathname])),(p.replace?u.replace:u.push)(b,p.state,p)},[r,u,d,s,a])}m.createContext(null);function DE(){let{matches:a}=m.useContext(Ya),r=a[a.length-1];return r?r.params:{}}function ki(a,{relative:r}={}){let{matches:u}=m.useContext(Ya),{pathname:c}=ql(),s=JSON.stringify(qg(u));return m.useMemo(()=>Yg(a,JSON.parse(s),c,r==="path"),[a,s,c,r])}function BE(a,r){return Qg(a)}function Qg(a,r,u,c){yt(Ui(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:s}=m.useContext(qa),{matches:d}=m.useContext(Ya),v=d[d.length-1],y=v?v.params:{},h=v?v.pathname:"/",p=v?v.pathnameBase:"/",b=v&&v.route;{let A=b&&b.path||"";Zg(h,!b||A.endsWith("*")||A.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${h}" (under <Route path="${A}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${A}"> to <Route path="${A==="/"?"*":`${A}/*`}">.`)}let x=ql(),S;S=x;let w=S.pathname||"/",_=w;if(p!=="/"){let A=p.replace(/^\//,"").split("/");_="/"+w.replace(/^\//,"").split("/").slice(A.length).join("/")}let B=Lg(a,{pathname:_});return Oa(b||B!=null,`No routes matched location "${S.pathname}${S.search}${S.hash}" `),Oa(B==null||B[B.length-1].route.element!==void 0||B[B.length-1].route.Component!==void 0||B[B.length-1].route.lazy!==void 0,`Matched leaf route at location "${S.pathname}${S.search}${S.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`),LE(B&&B.map(A=>Object.assign({},A,{params:Object.assign({},y,A.params),pathname:cl([p,s.encodeLocation?s.encodeLocation(A.pathname).pathname:A.pathname]),pathnameBase:A.pathnameBase==="/"?p:cl([p,s.encodeLocation?s.encodeLocation(A.pathnameBase).pathname:A.pathnameBase])})),d,u,c)}function zE(){let a=PE(),r=wE(a)?`${a.status} ${a.statusText}`:a instanceof Error?a.message:JSON.stringify(a),u=a instanceof Error?a.stack:null,c="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:c},d={padding:"2px 4px",backgroundColor:c},v=null;return console.error("Error handled by React Router default ErrorBoundary:",a),v=m.createElement(m.Fragment,null,m.createElement("p",null,"💿 Hey developer 👋"),m.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",m.createElement("code",{style:d},"ErrorBoundary")," or"," ",m.createElement("code",{style:d},"errorElement")," prop on your route.")),m.createElement(m.Fragment,null,m.createElement("h2",null,"Unexpected Application Error!"),m.createElement("h3",{style:{fontStyle:"italic"}},r),u?m.createElement("pre",{style:s},u):null,v)}var RE=m.createElement(zE,null),HE=class extends m.Component{constructor(a){super(a),this.state={location:a.location,revalidation:a.revalidation,error:a.error}}static getDerivedStateFromError(a){return{error:a}}static getDerivedStateFromProps(a,r){return r.location!==a.location||r.revalidation!=="idle"&&a.revalidation==="idle"?{error:a.error,location:a.location,revalidation:a.revalidation}:{error:a.error!==void 0?a.error:r.error,location:r.location,revalidation:a.revalidation||r.revalidation}}componentDidCatch(a,r){console.error("React Router caught the following error during render",a,r)}render(){return this.state.error!==void 0?m.createElement(Ya.Provider,{value:this.props.routeContext},m.createElement(Qf.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function jE({routeContext:a,match:r,children:u}){let c=m.useContext(yr);return c&&c.static&&c.staticContext&&(r.route.errorElement||r.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=r.route.id),m.createElement(Ya.Provider,{value:a},u)}function LE(a,r=[],u=null,c=null){if(a==null){if(!u)return null;if(u.errors)a=u.matches;else if(r.length===0&&!u.initialized&&u.matches.length>0)a=u.matches;else return null}let s=a,d=u==null?void 0:u.errors;if(d!=null){let h=s.findIndex(p=>p.route.id&&(d==null?void 0:d[p.route.id])!==void 0);yt(h>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(d).join(",")}`),s=s.slice(0,Math.min(s.length,h+1))}let v=!1,y=-1;if(u)for(let h=0;h<s.length;h++){let p=s[h];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(y=h),p.route.id){let{loaderData:b,errors:x}=u,S=p.route.loader&&!b.hasOwnProperty(p.route.id)&&(!x||x[p.route.id]===void 0);if(p.route.lazy||S){v=!0,y>=0?s=s.slice(0,y+1):s=[s[0]];break}}}return s.reduceRight((h,p,b)=>{let x,S=!1,w=null,_=null;u&&(x=d&&p.route.id?d[p.route.id]:void 0,w=p.route.errorElement||RE,v&&(y<0&&b===0?(Zg("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),S=!0,_=null):y===b&&(S=!0,_=p.route.hydrateFallbackElement||null)));let B=r.concat(s.slice(0,b+1)),O=()=>{let A;return x?A=w:S?A=_:p.route.Component?A=m.createElement(p.route.Component,null):p.route.element?A=p.route.element:A=h,m.createElement(jE,{match:p,routeContext:{outlet:h,matches:B,isDataRoute:u!=null},children:A})};return u&&(p.route.ErrorBoundary||p.route.errorElement||b===0)?m.createElement(HE,{location:u.location,revalidation:u.revalidation,component:w,error:x,children:O(),routeContext:{outlet:null,matches:B,isDataRoute:!0}}):O()},null)}function Zf(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function UE(a){let r=m.useContext(yr);return yt(r,Zf(a)),r}function kE(a){let r=m.useContext(Co);return yt(r,Zf(a)),r}function qE(a){let r=m.useContext(Ya);return yt(r,Zf(a)),r}function Ff(a){let r=qE(a),u=r.matches[r.matches.length-1];return yt(u.route.id,`${a} can only be used on routes that contain a unique "id"`),u.route.id}function YE(){return Ff("useRouteId")}function PE(){var c;let a=m.useContext(Qf),r=kE("useRouteError"),u=Ff("useRouteError");return a!==void 0?a:(c=r.errors)==null?void 0:c[u]}function GE(){let{router:a}=UE("useNavigate"),r=Ff("useNavigate"),u=m.useRef(!1);return Xg(()=>{u.current=!0}),m.useCallback(async(s,d={})=>{Oa(u.current,Vg),u.current&&(typeof s=="number"?a.navigate(s):await a.navigate(s,{fromRouteId:r,...d}))},[a,r])}var Tp={};function Zg(a,r,u){!r&&!Tp[a]&&(Tp[a]=!0,Oa(!1,u))}m.memo(VE);function VE({routes:a,future:r,state:u}){return Qg(a,void 0,u,r)}function XE({basename:a="/",children:r=null,location:u,navigationType:c="POP",navigator:s,static:d=!1}){yt(!Ui(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let v=a.replace(/^\/*/,"/"),y=m.useMemo(()=>({basename:v,navigator:s,static:d,future:{}}),[v,s,d]);typeof u=="string"&&(u=Li(u));let{pathname:h="/",search:p="",hash:b="",state:x=null,key:S="default"}=u,w=m.useMemo(()=>{let _=sl(h,v);return _==null?null:{location:{pathname:_,search:p,hash:b,state:x,key:S},navigationType:c}},[v,h,p,b,x,S,c]);return Oa(w!=null,`<Router basename="${v}"> is not able to match the URL "${h}${p}${b}" because it does not start with the basename, so the <Router> won't render anything.`),w==null?null:m.createElement(qa.Provider,{value:y},m.createElement(Do.Provider,{children:r,value:w}))}var po="get",go="application/x-www-form-urlencoded";function Bo(a){return a!=null&&typeof a.tagName=="string"}function QE(a){return Bo(a)&&a.tagName.toLowerCase()==="button"}function ZE(a){return Bo(a)&&a.tagName.toLowerCase()==="form"}function FE(a){return Bo(a)&&a.tagName.toLowerCase()==="input"}function KE(a){return!!(a.metaKey||a.altKey||a.ctrlKey||a.shiftKey)}function WE(a,r){return a.button===0&&(!r||r==="_self")&&!KE(a)}function Nf(a=""){return new URLSearchParams(typeof a=="string"||Array.isArray(a)||a instanceof URLSearchParams?a:Object.keys(a).reduce((r,u)=>{let c=a[u];return r.concat(Array.isArray(c)?c.map(s=>[u,s]):[[u,c]])},[]))}function JE(a,r){let u=Nf(a);return r&&r.forEach((c,s)=>{u.has(s)||r.getAll(s).forEach(d=>{u.append(s,d)})}),u}var uo=null;function IE(){if(uo===null)try{new FormData(document.createElement("form"),0),uo=!1}catch{uo=!0}return uo}var e6=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Ks(a){return a!=null&&!e6.has(a)?(Oa(!1,`"${a}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${go}"`),null):a}function t6(a,r){let u,c,s,d,v;if(ZE(a)){let y=a.getAttribute("action");c=y?sl(y,r):null,u=a.getAttribute("method")||po,s=Ks(a.getAttribute("enctype"))||go,d=new FormData(a)}else if(QE(a)||FE(a)&&(a.type==="submit"||a.type==="image")){let y=a.form;if(y==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let h=a.getAttribute("formaction")||y.getAttribute("action");if(c=h?sl(h,r):null,u=a.getAttribute("formmethod")||y.getAttribute("method")||po,s=Ks(a.getAttribute("formenctype"))||Ks(y.getAttribute("enctype"))||go,d=new FormData(y,a),!IE()){let{name:p,type:b,value:x}=a;if(b==="image"){let S=p?`${p}.`:"";d.append(`${S}x`,"0"),d.append(`${S}y`,"0")}else p&&d.append(p,x)}}else{if(Bo(a))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');u=po,c=null,s=go,v=a}return d&&s==="text/plain"&&(v=d,d=void 0),{action:c,method:u.toLowerCase(),encType:s,formData:d,body:v}}function Kf(a,r){if(a===!1||a===null||typeof a>"u")throw new Error(r)}async function a6(a,r){if(a.id in r)return r[a.id];try{let u=await import(a.module);return r[a.id]=u,u}catch(u){return console.error(`Error loading route module \`${a.module}\`, reloading page...`),console.error(u),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function l6(a){return a==null?!1:a.href==null?a.rel==="preload"&&typeof a.imageSrcSet=="string"&&typeof a.imageSizes=="string":typeof a.rel=="string"&&typeof a.href=="string"}async function n6(a,r,u){let c=await Promise.all(a.map(async s=>{let d=r.routes[s.route.id];if(d){let v=await a6(d,u);return v.links?v.links():[]}return[]}));return o6(c.flat(1).filter(l6).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function Ap(a,r,u,c,s,d){let v=(h,p)=>u[p]?h.route.id!==u[p].route.id:!0,y=(h,p)=>{var b;return u[p].pathname!==h.pathname||((b=u[p].route.path)==null?void 0:b.endsWith("*"))&&u[p].params["*"]!==h.params["*"]};return d==="assets"?r.filter((h,p)=>v(h,p)||y(h,p)):d==="data"?r.filter((h,p)=>{var x;let b=c.routes[h.route.id];if(!b||!b.hasLoader)return!1;if(v(h,p)||y(h,p))return!0;if(h.route.shouldRevalidate){let S=h.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:((x=u[0])==null?void 0:x.params)||{},nextUrl:new URL(a,window.origin),nextParams:h.params,defaultShouldRevalidate:!0});if(typeof S=="boolean")return S}return!0}):[]}function r6(a,r,{includeHydrateFallback:u}={}){return i6(a.map(c=>{let s=r.routes[c.route.id];if(!s)return[];let d=[s.module];return s.clientActionModule&&(d=d.concat(s.clientActionModule)),s.clientLoaderModule&&(d=d.concat(s.clientLoaderModule)),u&&s.hydrateFallbackModule&&(d=d.concat(s.hydrateFallbackModule)),s.imports&&(d=d.concat(s.imports)),d}).flat(1))}function i6(a){return[...new Set(a)]}function u6(a){let r={},u=Object.keys(a).sort();for(let c of u)r[c]=a[c];return r}function o6(a,r){let u=new Set;return new Set(r),a.reduce((c,s)=>{let d=JSON.stringify(u6(s));return u.has(d)||(u.add(d),c.push({key:d,link:s})),c},[])}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var c6=new Set([100,101,204,205]);function s6(a,r){let u=typeof a=="string"?new URL(a,typeof window>"u"?"server://singlefetch/":window.location.origin):a;return u.pathname==="/"?u.pathname="_root.data":r&&sl(u.pathname,r)==="/"?u.pathname=`${r.replace(/\/$/,"")}/_root.data`:u.pathname=`${u.pathname.replace(/\/$/,"")}.data`,u}function Fg(){let a=m.useContext(yr);return Kf(a,"You must render this element inside a <DataRouterContext.Provider> element"),a}function f6(){let a=m.useContext(Co);return Kf(a,"You must render this element inside a <DataRouterStateContext.Provider> element"),a}var Wf=m.createContext(void 0);Wf.displayName="FrameworkContext";function Kg(){let a=m.useContext(Wf);return Kf(a,"You must render this element inside a <HydratedRouter> element"),a}function d6(a,r){let u=m.useContext(Wf),[c,s]=m.useState(!1),[d,v]=m.useState(!1),{onFocus:y,onBlur:h,onMouseEnter:p,onMouseLeave:b,onTouchStart:x}=r,S=m.useRef(null);m.useEffect(()=>{if(a==="render"&&v(!0),a==="viewport"){let B=A=>{A.forEach(z=>{v(z.isIntersecting)})},O=new IntersectionObserver(B,{threshold:.5});return S.current&&O.observe(S.current),()=>{O.disconnect()}}},[a]),m.useEffect(()=>{if(c){let B=setTimeout(()=>{v(!0)},100);return()=>{clearTimeout(B)}}},[c]);let w=()=>{s(!0)},_=()=>{s(!1),v(!1)};return u?a!=="intent"?[d,S,{}]:[d,S,{onFocus:xi(y,w),onBlur:xi(h,_),onMouseEnter:xi(p,w),onMouseLeave:xi(b,_),onTouchStart:xi(x,w)}]:[!1,S,{}]}function xi(a,r){return u=>{a&&a(u),u.defaultPrevented||r(u)}}function h6({page:a,...r}){let{router:u}=Fg(),c=m.useMemo(()=>Lg(u.routes,a,u.basename),[u.routes,a,u.basename]);return c?m.createElement(p6,{page:a,matches:c,...r}):null}function m6(a){let{manifest:r,routeModules:u}=Kg(),[c,s]=m.useState([]);return m.useEffect(()=>{let d=!1;return n6(a,r,u).then(v=>{d||s(v)}),()=>{d=!0}},[a,r,u]),c}function p6({page:a,matches:r,...u}){let c=ql(),{manifest:s,routeModules:d}=Kg(),{basename:v}=Fg(),{loaderData:y,matches:h}=f6(),p=m.useMemo(()=>Ap(a,r,h,s,c,"data"),[a,r,h,s,c]),b=m.useMemo(()=>Ap(a,r,h,s,c,"assets"),[a,r,h,s,c]),x=m.useMemo(()=>{if(a===c.pathname+c.search+c.hash)return[];let _=new Set,B=!1;if(r.forEach(A=>{var L;let z=s.routes[A.route.id];!z||!z.hasLoader||(!p.some(J=>J.route.id===A.route.id)&&A.route.id in y&&((L=d[A.route.id])!=null&&L.shouldRevalidate)||z.hasClientLoader?B=!0:_.add(A.route.id))}),_.size===0)return[];let O=s6(a,v);return B&&_.size>0&&O.searchParams.set("_routes",r.filter(A=>_.has(A.route.id)).map(A=>A.route.id).join(",")),[O.pathname+O.search]},[v,y,c,s,p,r,a,d]),S=m.useMemo(()=>r6(b,s),[b,s]),w=m6(b);return m.createElement(m.Fragment,null,x.map(_=>m.createElement("link",{key:_,rel:"prefetch",as:"fetch",href:_,...u})),S.map(_=>m.createElement("link",{key:_,rel:"modulepreload",href:_,...u})),w.map(({key:_,link:B})=>m.createElement("link",{key:_,...B})))}function g6(...a){return r=>{a.forEach(u=>{typeof u=="function"?u(r):u!=null&&(u.current=r)})}}var Wg=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Wg&&(window.__reactRouterVersion="7.6.3")}catch{}function v6({basename:a,children:r,window:u}){let c=m.useRef();c.current==null&&(c.current=lE({window:u,v5Compat:!0}));let s=c.current,[d,v]=m.useState({action:s.action,location:s.location}),y=m.useCallback(h=>{m.startTransition(()=>v(h))},[v]);return m.useLayoutEffect(()=>s.listen(y),[s,y]),m.createElement(XE,{basename:a,children:r,location:d.location,navigationType:d.action,navigator:s})}var Jg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ig=m.forwardRef(function({onClick:r,discover:u="render",prefetch:c="none",relative:s,reloadDocument:d,replace:v,state:y,target:h,to:p,preventScrollReset:b,viewTransition:x,...S},w){let{basename:_}=m.useContext(qa),B=typeof p=="string"&&Jg.test(p),O,A=!1;if(typeof p=="string"&&B&&(O=p,Wg))try{let ne=new URL(window.location.href),he=p.startsWith("//")?new URL(ne.protocol+p):new URL(p),Be=sl(he.pathname,_);he.origin===ne.origin&&Be!=null?p=Be+he.search+he.hash:A=!0}catch{Oa(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let z=OE(p,{relative:s}),[L,J,Q]=d6(c,S),te=x6(p,{replace:v,state:y,target:h,preventScrollReset:b,relative:s,viewTransition:x});function ae(ne){r&&r(ne),ne.defaultPrevented||te(ne)}let de=m.createElement("a",{...S,...Q,href:O||z,onClick:A||d?r:ae,ref:g6(w,J),target:h,"data-discover":!B&&u==="render"?"true":void 0});return L&&!B?m.createElement(m.Fragment,null,de,m.createElement(h6,{page:z})):de});Ig.displayName="Link";var y6=m.forwardRef(function({"aria-current":r="page",caseSensitive:u=!1,className:c="",end:s=!1,style:d,to:v,viewTransition:y,children:h,...p},b){let x=ki(v,{relative:p.relative}),S=ql(),w=m.useContext(Co),{navigator:_,basename:B}=m.useContext(qa),O=w!=null&&w6(x)&&y===!0,A=_.encodeLocation?_.encodeLocation(x).pathname:x.pathname,z=S.pathname,L=w&&w.navigation&&w.navigation.location?w.navigation.location.pathname:null;u||(z=z.toLowerCase(),L=L?L.toLowerCase():null,A=A.toLowerCase()),L&&B&&(L=sl(L,B)||L);const J=A!=="/"&&A.endsWith("/")?A.length-1:A.length;let Q=z===A||!s&&z.startsWith(A)&&z.charAt(J)==="/",te=L!=null&&(L===A||!s&&L.startsWith(A)&&L.charAt(A.length)==="/"),ae={isActive:Q,isPending:te,isTransitioning:O},de=Q?r:void 0,ne;typeof c=="function"?ne=c(ae):ne=[c,Q?"active":null,te?"pending":null,O?"transitioning":null].filter(Boolean).join(" ");let he=typeof d=="function"?d(ae):d;return m.createElement(Ig,{...p,"aria-current":de,className:ne,ref:b,style:he,to:v,viewTransition:y},typeof h=="function"?h(ae):h)});y6.displayName="NavLink";var b6=m.forwardRef(({discover:a="render",fetcherKey:r,navigate:u,reloadDocument:c,replace:s,state:d,method:v=po,action:y,onSubmit:h,relative:p,preventScrollReset:b,viewTransition:x,...S},w)=>{let _=_6(),B=N6(y,{relative:p}),O=v.toLowerCase()==="get"?"get":"post",A=typeof y=="string"&&Jg.test(y),z=L=>{if(h&&h(L),L.defaultPrevented)return;L.preventDefault();let J=L.nativeEvent.submitter,Q=(J==null?void 0:J.getAttribute("formmethod"))||v;_(J||L.currentTarget,{fetcherKey:r,method:Q,navigate:u,replace:s,state:d,relative:p,preventScrollReset:b,viewTransition:x})};return m.createElement("form",{ref:w,method:O,action:B,onSubmit:c?h:z,...S,"data-discover":!A&&a==="render"?"true":void 0})});b6.displayName="Form";function S6(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ev(a){let r=m.useContext(yr);return yt(r,S6(a)),r}function x6(a,{target:r,replace:u,state:c,preventScrollReset:s,relative:d,viewTransition:v}={}){let y=br(),h=ql(),p=ki(a,{relative:d});return m.useCallback(b=>{if(WE(b,r)){b.preventDefault();let x=u!==void 0?u:Di(h)===Di(p);y(a,{replace:x,state:c,preventScrollReset:s,relative:d,viewTransition:v})}},[h,y,p,u,c,r,a,s,d,v])}function tv(a){Oa(typeof URLSearchParams<"u","You cannot use the `useSearchParams` hook in a browser that does not support the URLSearchParams API. If you need to support Internet Explorer 11, we recommend you load a polyfill such as https://github.com/ungap/url-search-params.");let r=m.useRef(Nf(a)),u=m.useRef(!1),c=ql(),s=m.useMemo(()=>JE(c.search,u.current?null:r.current),[c.search]),d=br(),v=m.useCallback((y,h)=>{const p=Nf(typeof y=="function"?y(s):y);u.current=!0,d("?"+p,h)},[d,s]);return[s,v]}var E6=0,$6=()=>`__${String(++E6)}__`;function _6(){let{router:a}=ev("useSubmit"),{basename:r}=m.useContext(qa),u=YE();return m.useCallback(async(c,s={})=>{let{action:d,method:v,encType:y,formData:h,body:p}=t6(c,r);if(s.navigate===!1){let b=s.fetcherKey||$6();await a.fetch(b,u,s.action||d,{preventScrollReset:s.preventScrollReset,formData:h,body:p,formMethod:s.method||v,formEncType:s.encType||y,flushSync:s.flushSync})}else await a.navigate(s.action||d,{preventScrollReset:s.preventScrollReset,formData:h,body:p,formMethod:s.method||v,formEncType:s.encType||y,replace:s.replace,state:s.state,fromRouteId:u,flushSync:s.flushSync,viewTransition:s.viewTransition})},[a,r,u])}function N6(a,{relative:r}={}){let{basename:u}=m.useContext(qa),c=m.useContext(Ya);yt(c,"useFormAction must be used inside a RouteContext");let[s]=c.matches.slice(-1),d={...ki(a||".",{relative:r})},v=ql();if(a==null){d.search=v.search;let y=new URLSearchParams(d.search),h=y.getAll("index");if(h.some(b=>b==="")){y.delete("index"),h.filter(x=>x).forEach(x=>y.append("index",x));let b=y.toString();d.search=b?`?${b}`:""}}return(!a||a===".")&&s.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),u!=="/"&&(d.pathname=d.pathname==="/"?u:cl([u,d.pathname])),Di(d)}function w6(a,r={}){let u=m.useContext(Gg);yt(u!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=ev("useViewTransitionState"),s=ki(a,{relative:r.relative});if(!u.isTransitioning)return!1;let d=sl(u.currentLocation.pathname,c)||u.currentLocation.pathname,v=sl(u.nextLocation.pathname,c)||u.nextLocation.pathname;return Eo(s.pathname,v)!=null||Eo(s.pathname,d)!=null}[...c6];const T6=V.div`
  ${({$variant:a})=>Ne[a]}
`,mn=({type:a="span",variant:r,className:u,children:c})=>$.jsx(T6,{as:a,$variant:r,className:u,children:c}),A6="_indexPage_1vdx4_1",M6="_title_1vdx4_5",Mp={indexPage:A6,title:M6},O6="_taskTracker_16ovt_1",C6="_control_16ovt_6",D6="_buttons_16ovt_16",Ws={taskTracker:O6,control:C6,buttons:D6},Bi=["Bug","Feature","Documentation","Refactor","Test"],$o=["To Do","In Progress","Done"],zi=["Low","Medium","High"],B6="_filters_bsouf_1",z6="_selectFields_bsouf_13",Op={filters:B6,selectFields:z6},R6=(a,r)=>{const[u,c]=m.useState(a);return m.useEffect(()=>{const s=setTimeout(()=>c(a),r);return()=>clearTimeout(s)},[a,r]),u},H6=()=>{const[a]=tv(),r=br(),[u,c]=m.useState(""),[s,d]=m.useState(null),[v,y]=m.useState(null),h=R6(u,500),p=m.useRef(!0);m.useEffect(()=>{if(!p.current)return;const S=a.get("q")||"",w=a.get("priority"),_=a.get("category");c(S),d(zi.includes(w)?w:null),y(Bi.includes(_)?_:null),setTimeout(()=>p.current=!1,600)},[a]),m.useEffect(()=>{if(p.current)return;const S=new URLSearchParams;h&&S.set("q",h),s&&S.set("priority",s),v&&S.set("category",v),r({search:S.toString()},{replace:!0})},[h,s,v,r]);const b=S=>{const w=S.target.value;y(_=>_===w?null:w)},x=S=>{const w=S.target.value;d(_=>_===w?null:w)};return $.jsxs("div",{className:Op.filters,children:[$.jsx(xo,{value:u,onChange:S=>c(S.target.value),placeholder:"Введите название",label:"Поиск по задаче"}),$.jsxs("div",{className:Op.selectFields,children:[$.jsxs(ir,{"data-container-id":"selectFieldPriority",mode:"searchSelect",label:"Приоритет",value:s??"",onChange:x,children:[$.jsx(sn,{value:"",children:"— Не выбрано —"}),zi.map(S=>$.jsx(sn,{value:S,children:S},S))]}),$.jsxs(ir,{"data-container-id":"selectFieldCategory",mode:"searchSelect",label:"Категория",value:v??"",onChange:b,children:[$.jsx(sn,{value:"",children:"— Не выбрано —"}),Bi.map(S=>$.jsx(sn,{value:S,children:S},S))]})]})]})},j6="_taskList_t4l9z_1",L6={taskList:j6},U6="_card_1dat1_1",k6="_title_1dat1_11",q6="_description_1dat1_15",Y6="_tagGroup_1dat1_19",P6="_createdAt_1dat1_26",G6="_controlBlock_1dat1_30",V6="_deleteButton_1dat1_37",on={card:U6,title:k6,description:q6,tagGroup:Y6,createdAt:P6,controlBlock:G6,deleteButton:V6},X6=({name:a,size:r={width:24,height:24},className:u=""})=>$.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",style:{width:r.width,height:r.height},className:u,children:$.jsx("use",{xlinkHref:`/t1-homework-1/assets/images/vector/sprites.svg#${a}`})});function Q6(a){const r=typeof a=="string"?new Date(a):a,u=r.toLocaleDateString("ru-RU",{day:"numeric",month:"long",year:"numeric"}),c=r.toLocaleTimeString("ru-RU",{hour:"2-digit",minute:"2-digit"});return`${u} в ${c}`}const Z6=({task:a,onDelete:r})=>{const u=br(),c=()=>{u(`task/${a.id}`)};return $.jsx("div",{className:on.card,children:$.jsxs("div",{children:[$.jsx(mn,{type:"p",variant:"Main/S",className:on.title,children:a.title}),a.description&&$.jsx(mn,{type:"p",variant:"Additional/XS",className:on.description,children:a.description}),$.jsxs("div",{className:on.tagGroup,children:[$.jsxs(mo,{dimension:"s",kind:"neutral",children:["Категория: ",a.category]}),$.jsxs(mo,{dimension:"s",kind:"neutral",children:["Статус: ",a.status]}),$.jsxs(mo,{dimension:"s",kind:"neutral",children:["Приоритет: ",a.priority]})]}),$.jsx(mn,{type:"p",variant:"Caption/XS",className:on.createdAt,children:Q6(a.createdAt)}),$.jsxs("div",{className:on.controlBlock,children:[$.jsx(mr,{dimension:"s",appearance:"tertiary",onClick:c,children:"Редактировать"}),$.jsx("button",{className:on.deleteButton,onClick:()=>r(a.id),children:$.jsx(X6,{name:"delete"})})]})]})})},F6="_title_1fykk_1",K6="_taskList_1fykk_6",Js={title:F6,taskList:K6},W6=({title:a,tasks:r,onDelete:u})=>$.jsxs("div",{className:Js.statusColumn,children:[$.jsx(mn,{type:"h2",variant:"Header/H2",className:Js.title,children:a}),$.jsx(Ci,{}),$.jsx("ul",{className:Js.taskList,children:r.map(c=>$.jsx("li",{children:$.jsx(Z6,{task:c,onDelete:u})},c.id))})]}),Mt=[];for(let a=0;a<256;++a)Mt.push((a+256).toString(16).slice(1));function J6(a,r=0){return(Mt[a[r+0]]+Mt[a[r+1]]+Mt[a[r+2]]+Mt[a[r+3]]+"-"+Mt[a[r+4]]+Mt[a[r+5]]+"-"+Mt[a[r+6]]+Mt[a[r+7]]+"-"+Mt[a[r+8]]+Mt[a[r+9]]+"-"+Mt[a[r+10]]+Mt[a[r+11]]+Mt[a[r+12]]+Mt[a[r+13]]+Mt[a[r+14]]+Mt[a[r+15]]).toLowerCase()}let Is;const I6=new Uint8Array(16);function e3(){if(!Is){if(typeof crypto>"u"||!crypto.getRandomValues)throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");Is=crypto.getRandomValues.bind(crypto)}return Is(I6)}const t3=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),Cp={randomUUID:t3};function a3(a,r,u){var s;if(Cp.randomUUID&&!a)return Cp.randomUUID();a=a||{};const c=a.random??((s=a.rng)==null?void 0:s.call(a))??e3();if(c.length<16)throw new Error("Random bytes length must be >= 16");return c[6]=c[6]&15|64,c[8]=c[8]&63|128,J6(c)}const Dp=[{id:"1",title:"Исправить баг с логином",description:"Проблема с повторным входом",category:"Bug",status:"In Progress",priority:"High",createdAt:new Date("2025-07-12T14:25:00")},{id:"2",title:"Добавить возможность восстановления пароля",description:"Пользователи должны иметь возможность восстанавливать пароль через email",category:"Feature",status:"To Do",priority:"Medium",createdAt:new Date("2025-07-04T09:42:00")},{id:"3",title:"Обновить документацию по API",description:"Добавить описание новых эндпоинтов",category:"Documentation",status:"Done",priority:"Low",createdAt:new Date("2025-07-08T11:10:00")},{id:"4",title:"Рефакторинг компонента профиля",description:"Упростить логику и улучшить читаемость кода",category:"Refactor",status:"In Progress",priority:"Medium",createdAt:new Date("2025-07-01T16:35:00")},{id:"5",title:"Написать тесты для формы регистрации",description:"Покрыть юнит-тестами все основные сценарии",category:"Test",status:"To Do",priority:"High",createdAt:new Date("2025-07-10T08:15:00")},{id:"6",title:"Исправить отображение кнопок на мобильных устройствах",category:"Bug",status:"To Do",priority:"Medium",createdAt:new Date("2025-07-03T12:20:00")},{id:"7",title:"Добавить темную тему",description:"Реализовать переключение светлой и темной темы",category:"Feature",status:"In Progress",priority:"High",createdAt:new Date("2025-07-14T17:55:00")},{id:"8",title:"Обновить зависимости проекта",description:"Обновить библиотеки до последних стабильных версий",category:"Refactor",status:"Done",priority:"Low",createdAt:new Date("2025-07-06T10:05:00")}],qi={get(){const a=localStorage.getItem("tasks");return a?JSON.parse(a):[]},set(a){localStorage.setItem("tasks",JSON.stringify(a))}},l3=()=>(qi.set(Dp),Dp),Yi=a=>{const r=qi.get();return a?r.filter(u=>{const c=!a.q||u.title.toLowerCase().includes(a.q.toLowerCase()),s=!a.priority||u.priority===a.priority,d=!a.category||u.category===a.category;return c&&s&&d}):r},n3=a=>{const u=Yi().find(c=>c.id===a);if(!u)throw new Error(`Задача с id "${a}" не найдена`);return u},r3=a=>{if(!a.title)throw new Error("Название не может быть пустым");const r=Yi(),u={id:a3(),createdAt:new Date,...a};return r.push(u),qi.set(r),u},i3=(a,r)=>{if(!r.title)throw new Error("Название не может быть пустым");const u=Yi(),c=u.findIndex(d=>d.id===a);if(c===-1)throw new Error(`Не удалось обновить: задача с id "${a}" не найдена`);const s={...u[c],...r};return u[c]=s,qi.set(u),s},u3=a=>{const r=Yi(),u=r.findIndex(c=>c.id===a);if(u===-1)throw new Error(`Не удалось удалить: задача с id "${a}" не найдена`);return r.splice(u,1),qi.set(r),!0},o3=a=>new Promise(r=>setTimeout(r,a)),ur=async(a,r,u,c)=>{await o3(300);const d=r.replace(/^\/+|\/+$/g,"").split("/");if(d[0]!=="tasks"||d.length>2)throw new Error(`Маршрут [${a} ${r}] не найден`);switch(a){case"GET":return d.length===2?n3(d[1]):Yi(c);case"POST":if(d.length===2&&d[1]==="init")return l3();if(u)return r3(u);throw new Error("Отсутствует тело запроса");case"PATCH":if(d.length===2&&u)return i3(d[1],u);throw new Error("Отсутствует тело запроса");case"DELETE":if(d.length===2)return u3(d[1]);break}throw new Error(`Маршрут [${a} ${r}] не найден`)},c3=()=>{const[a]=tv(),[r,u]=m.useState([]),[c,s]=m.useState(null);m.useEffect(()=>{const y=a.get("priority"),h=a.get("category"),p={q:a.get("q")||void 0,priority:zi.includes(y)?y:void 0,category:Bi.includes(h)?h:void 0};ur("GET","tasks",void 0,p).then(b=>b).then(b=>u(b)).catch(()=>s(new Error("Ошибка загрузки задач")))},[a]);const d=y=>{ur("DELETE",`tasks/${y}`).then(()=>u(h=>h.filter(p=>p.id!==y))).catch(h=>console.error(h.message))},v=$o.reduce((y,h)=>(y[h]=r.filter(p=>p.status===h),y),{});return c?$.jsx("div",{children:c.message}):$.jsx("div",{className:L6.taskList,children:$o.map(y=>$.jsx(W6,{title:y,tasks:v[y],onDelete:d},y))})},s3=()=>{const a=br(),r=()=>{a("/task/new")},u=()=>{ur("POST","tasks/init").then(()=>window.location.reload())};return $.jsxs("div",{className:Ws.taskTracker,children:[$.jsx(Ci,{}),$.jsxs("div",{className:Ws.control,children:[$.jsx(H6,{}),$.jsxs("div",{className:Ws.buttons,children:[$.jsx(mr,{dimension:"s",appearance:"secondary",onClick:u,children:"Заполнить mock-данными"}),$.jsx(mr,{dimension:"s",appearance:"primary",onClick:r,children:"Создать задачу"})]})]}),$.jsx(Ci,{}),$.jsx(c3,{})]})},f3=()=>$.jsxs("div",{className:Mp.indexPage,children:[$.jsx(mn,{type:"h1",variant:"Header/H1",className:Mp.title,children:"Трекер задач"}),$.jsx(s3,{})]}),d3="_form_1mupg_1",h3="_error_1mupg_6",m3="_caption_1mupg_11",p3="_fields_1mupg_15",g3="_buttons_1mupg_22",Ei={form:d3,error:h3,caption:m3,fields:p3,buttons:g3},Bp=({id:a})=>{const r=br(),[u,c]=m.useState({title:"",description:"",category:Bi[0],status:$o[0],priority:zi[0]}),[s,d]=m.useState(null);m.useEffect(()=>{a&&ur("GET",`tasks/${a}`).then(h=>h).then(h=>c({title:h.title,description:h.description,status:h.status,category:h.category,priority:h.priority})).catch(()=>r("/"))},[a,r]);const v=(h,p)=>{c(b=>({...b,[h]:p}))},y=()=>{u.title.length>0&&(a?ur("PATCH",`tasks/${a}`,u).then(()=>r("/")).catch(h=>d(h)):ur("POST","tasks",u).then(()=>r("/")).catch(h=>d(h)))};return $.jsxs("form",{className:Ei.form,onSubmit:h=>{h.preventDefault(),y()},children:[$.jsx(mn,{type:"h1",variant:"Header/H1",className:Ei.caption,children:a?"Редактировать задачу":"Создать задачу"}),$.jsx(Ci,{}),$.jsxs("div",{className:Ei.fields,children:[$.jsx(xo,{value:u.title,onChange:h=>v("title",h.target.value),placeholder:"Введите заголовок",label:"Заголовок",status:u.title.length>0?void 0:"error",required:!0}),$.jsx(xo,{value:u.description,onChange:h=>v("description",h.target.value),placeholder:"Введите описание",label:"Описание"}),$.jsx(ir,{"data-container-id":"selectFieldCategory",mode:"searchSelect",label:"Категория",value:u.category,onChange:h=>v("category",h.target.value),required:!0,children:Bi.map(h=>$.jsx(sn,{value:h,children:h},h))}),$.jsx(ir,{"data-container-id":"selectFieldStatus",mode:"searchSelect",label:"Статус",value:u.status,onChange:h=>v("status",h.target.value),required:!0,children:$o.map(h=>$.jsx(sn,{value:h,children:h},h))}),$.jsx(ir,{"data-container-id":"selectFieldPriotity",mode:"searchSelect",label:"Приоритет",value:u.priority,onChange:h=>v("priority",h.target.value),required:!0,children:zi.map(h=>$.jsx(sn,{value:h,children:h},h))}),s&&$.jsx(mn,{type:"p",variant:"Additional/S",className:Ei.error,children:s.message})]}),$.jsxs("div",{className:Ei.buttons,children:[$.jsx(mr,{type:"submit",dimension:"s",appearance:"primary",children:"Сохранить"}),$.jsx(mr,{type:"button",dimension:"s",appearance:"secondary",onClick:()=>r("/"),children:"Отменить"})]})]})},v3="_taskPage_1n59p_1",y3={taskPage:v3},b3=()=>{const{id:a}=DE();return $.jsx("div",{className:y3.taskPage,children:a!=="new"?$.jsx(Bp,{id:a}):$.jsx(Bp,{})})},S3=[{path:"/",element:$.jsx(f3,{})},{path:"/task/:id",element:$.jsx(b3,{})}],x3=()=>BE(S3);function E3(){return $.jsx(v6,{basename:"/t1-homework-1/",children:$.jsx(x3,{})})}h1.createRoot(document.getElementById("root")).render($.jsx(m.StrictMode,{children:$.jsx(db,{theme:Df,children:$.jsxs(wb,{children:[$.jsx(tE,{}),$.jsx(E3,{})]})})}));
